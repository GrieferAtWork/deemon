...
The files in here are _ONLY_ meant for backwards compatibility with deemon 100+,
...
In v200, deemon 200+ has been overhauled when it comes to how scripts should
...
implicitly a #include-path after appending `/include' to that path, which is how
