...
#define ASM_RET_NONE          0x00 /* [1][-0,+0]   `ret'                                - Return `none' to the caller. This instruction does not return.
                                    ...
                                    *                                                           This is also the case for GriferAtWork's implementation.
                                    * >> IF IS_BOUND(REG_RESULT) THEN
                                    * >>     REG_RESULT = UNBOUND;
                                    * >> FI
...
#define ASM_RETHROW           0x04 /* [1][-0,+0]   `throw except'                       - Rethrow the current exception (Used to terminate catch-blocks, and generated by `throw' without an argument).
                                    * >> EXCEPT(); */
#define ASM_SETRET            0x05 /* [1][-1,+0]   `setret pop'                         - Set the contens of the return register.
                                    ...
                                    * before proceeding to execute it, before `end finally' is
                                    * encountered at its end, which will check for the result register
                                    * to be bound, and return if it is. */
