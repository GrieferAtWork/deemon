...
#define DeeSeq_InitOneUninitializedInherited(self, item) \
	((self)->so_item = (item), Dee_AsObject(self))
#define DeeSeq_InitOneUninitialized(self, item) \
	((self)->so_item = (item), Dee_AsObject(self))
#else /* __INTELLISENSE__ */
...
#define DeeSeq_NewOneUninitialized()      ((DeeSeqOneObject *)sizeof(DeeSeqOneObject))
#define DeeSeq_FreeOneUninitialized(self) (void)Dee_REQUIRES_TYPE(DeeSeqOneObject *, self)
#define DeeSeq_InitOneUninitialized(self, item) DeeSeq_InitOneUninitializedInherited(self, item)
#else /* __INTELLISENSE__ */
...
#define DeeSeqPair_ELEM(self) Dee_REQUIRES_TYPE(DeeSeqPairObject const *, self)->sp_items
...
#define DeeSeqPair_ELEM(self) Dee_REQUIRES_TYPE(DeeSeqPairObject const *, self)->t_elem
#else /* __INTELLISENSE__ */
...
#define DeeSeq_InitPairUninitializedInherited(self, a, b) \
	((self)->sp_items[0] = (a), (self)->sp_items[1] = (b), Dee_AsObject(self))
#define DeeSeq_InitPairUninitialized(self, a, b) \
	((self)->sp_items[0] = (a), (self)->sp_items[1] = (b), Dee_AsObject(self))
#else /* __INTELLISENSE__ */
...
#define DeeSeq_NewPairUninitialized()            ((DeeSeqPairObject *)sizeof(DeeSeqPairObject))
#define DeeSeq_FreePairUninitialized(self)       (void)Dee_REQUIRES_TYPE(DeeSeqPairObject *, self)
#define DeeSeq_InitPairUninitialized(self, a, b) DeeSeq_InitPairUninitializedInherited(self, a, b)
#else /* __INTELLISENSE__ */
