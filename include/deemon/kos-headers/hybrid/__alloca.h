 ...
 */
/*!export __hybrid_alloca __hybrid_alloca_IS_**/
...
__NAMESPACE_INT_END
__SYSDECL_END
#define __hybrid_alloca_IS__alloca
#define __hybrid_alloca (__NAMESPACE_INT_SYM _alloca)
#elif defined(_AIX)
#define __hybrid_alloca_IS___alloca
