...
#define __pic__ 1 /*!export*/ /* PositionIndependentCode (try to minimize relocations) */
#endif /* __pic__... */
...
#ifdef __DJGPP
#define __DJGPP__ __DJGPP /*!export*/
#else /* __DJGPP */
...
#define __x86_64__ 1 /*!export*/
#endif /* __x86_64__... */

#if (!defined(__i686__) && \
     (defined(__i686) || defined(i686)))
#define __i686__ 1 /*!export*/
#endif /* __i686__... */

#if (!defined(__i586__) && \
     (defined(__i586) || defined(i586)))
#define __i586__ 1 /*!export*/
#endif /* __i586__... */

#if (!defined(__i486__) && \
     (defined(__i486) || defined(i486)))
#define __i486__ 1 /*!export*/
#endif /* __i486__... */
...
#define __hp9000s800__ 1 /*!export*/
...
#define __powerpc__ 1 /*!export*/
#endif /* __powerpc__... */

#if (!defined(__powerpc64__) && defined(__PPC64__))
#define __powerpc64__ 1 /*!export*/
#endif /* __powerpc64__... */
...
#define __ARCH_HAVE_UNALIGNED_MEMORY_ACCESS /*!export*/
...
#define __ARCH_VA_LIST_IS_STACK_POINTER /*!export*/
#endif /* ... */
...
#define __ARCH_STACK_GROWS_DOWNWARDS /*!export*/
#elif !defined(_STACK_GROWS_DOWNWARD) && defined(_STACK_GROWS_UPWARD)
#define __ARCH_STACK_GROWS_UPWARDS /*!export*/
...
#define __ARCH_STACK_ALIGNMENT 8 /*!export*/
#endif /* ... */
...
#define __ARCH_PAGESIZE 4096 /*!export*/
#endif /* ... */
