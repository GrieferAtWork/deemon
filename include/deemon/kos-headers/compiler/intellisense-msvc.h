...
template<class __T, __SIZE_TYPE__ __N> __T (&operator , (__T(&&)[__N],____INTELLISENSE_void_helper))[__N];
template<class __T, __SIZE_TYPE__ __N> __T const (&operator , (__T const (&&)[__N],____INTELLISENSE_void_helper))[__N];
...
template<class __T, __SIZE_TYPE__ __N> typename ____INTELLISENSE_remlval<__T[__N]>::__type &____INTELLISENSE_typeof_helper(__T(&)[__N]);
template<class __T, __SIZE_TYPE__ __N> typename ____INTELLISENSE_remlval<__T[__N]>::__type const &____INTELLISENSE_typeof_helper(__T const (&)[__N]);
...
__attribute__((__noreturn__)) void __builtin_abort();
__attribute__((__noreturn__)) void __builtin_unreachable();
__attribute__((__noreturn__)) void __builtin_trap();
__attribute__((__noreturn__)) void __builtin_exit();
__attribute__((__noreturn__)) void __builtin__exit();
__attribute__((__noreturn__)) void __builtin__Exit();
...
template<class __T, class __S> typename ::__intern::____INTELLISENSE_enableif< ::__intern::____INTELLISENSE_isarith<__T>::__value && ::__intern::____INTELLISENSE_isarith<__S>::__value, bool>::__type (__atomic_compare_exchange_n)(__T volatile *ptr, __T *expected, __S desired, bool weak, int success_memorder, int failure_memorder);
template<class __T, class __S> typename ::__intern::____INTELLISENSE_enableif< ::__intern::____INTELLISENSE_isarith<__T>::__value && ::__intern::____INTELLISENSE_isarith<__S>::__value, bool>::__type (__atomic_compare_exchange_n)(__T volatile *ptr, __T volatile *expected, __S desired, bool weak, int success_memorder, int failure_memorder);
...
bool __atomic_always_lock_free(__INTELLISENSE_SIZE_TYPE__ size, void const volatile *ptr);
bool __atomic_is_lock_free(__INTELLISENSE_SIZE_TYPE__ size, void const volatile *ptr);
...
class ____INTELLISENSE_char16_t {
	unsigned short __v;
public:
	operator unsigned short & () throw();
	operator unsigned short const & () const throw();
...
public:
	...
	operator unsigned int const & () const throw();
