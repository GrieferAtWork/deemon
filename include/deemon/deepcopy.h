...
#include "alloc.h"  /* DeeObject_*, Dee_Free, Dee_MallocUsableSizeNonNull */
...
#else /* __INTELLISENSE__ */
#define Dee_deepcopy_heap_getnext(self)    (*(void *const *)((__BYTE_TYPE__ *)(self) + Dee_MallocUsableSizeNonNull(self) - sizeof(void *)))
#define Dee_deepcopy_heap_setnext(self, v) (*(void **)((__BYTE_TYPE__ *)(self) + Dee_MallocUsableSizeNonNull(self) - sizeof(void *)) = (v))
 ...
 * >>    return DeeSeq_OfPairInherited(copy1, copy2);
 * >>err:
