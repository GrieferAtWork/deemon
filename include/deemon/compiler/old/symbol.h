...
/*!export scope_**/
/*!export symbol_**/
#ifndef GUARD_DEEMON_COMPILER_OLD_SYMBOL_H
#define GUARD_DEEMON_COMPILER_OLD_SYMBOL_H 1 /*!export-*/
...
decl_ast_initfunc(struct decl_ast *__restrict self,
	...
	Dee_weakref_init(&self->da_func.f_scope,
	                 Dee_AsObject(&function_scope->bs_scope),
	                 NULL);
}
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_SYMBOL_H */
