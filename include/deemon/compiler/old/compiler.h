...
#ifndef GUARD_DEEMON_COMPILER_OLD_COMPILER_H
#define GUARD_DEEMON_COMPILER_OLD_COMPILER_H 1 /*!export-*/
...
#ifdef GUARD_DEEMON_COMPILER_OLD_COMPILER_C
DDATDEF Dee_WEAKREF(DeeCompilerObject) DeeCompiler_Active;
#else /* GUARD_DEEMON_COMPILER_OLD_COMPILER_C */
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_COMPILER_H */
