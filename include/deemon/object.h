...
DFUNDEF WUNUSED NONNULL((1, 2, 5)) bool DCALL DeeObject_TGenericFindPrivateAttrInfoStringLenHash(DeeTypeObject *tp_self, char const *__restrict attr, size_t attrlen, Dee_hash_t hash, struct Dee_attrinfo *__restrict retinfo);
...
DFUNDEF WUNUSED NONNULL((1)) int DCALL DeeObject_Bool(DeeObject *__restrict self); /* TODO: Check uses of this function & replace with "DeeObject_BoolInherited" if appropriate. */
