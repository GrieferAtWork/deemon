...
#include <hybrid/typecore.h>  /* __BYTE_TYPE__, __CHAR_UNSIGNED__, __SBYTE_TYPE__, __SIZEOF_*, __UINT8_TYPE__, __UINT32_C, __UINT64_C, __UINTPTR_HALF_TYPE__, __UINTPTR_TYPE__ */
