...
/*[[[deemon (CxxType from rt.gen.cxxapi)(List from deemon).printCxxApi(templateParameters: { "T" });]]]*/
	...
	void (resize)(Dee_ssize_t newsize) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "resize", _Dee_HashSelect(UINT32_C(0x36fcb308), UINT64_C(0x573f3d2e97212b34)),  DEE_PCKdSIZ, newsize)));
	}
	NONNULL_CXX((2)) void (resize)(Dee_ssize_t newsize, DeeObject *filler) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "resize", _Dee_HashSelect(UINT32_C(0x36fcb308), UINT64_C(0x573f3d2e97212b34)),  DEE_PCKdSIZ "o", newsize, filler)));
	}
	void (resize)(size_t newsize) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "resize", _Dee_HashSelect(UINT32_C(0x36fcb308), UINT64_C(0x573f3d2e97212b34)),  DEE_PCKuSIZ, newsize)));
	}
	NONNULL_CXX((2)) void (resize)(size_t newsize, DeeObject *filler) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "resize", _Dee_HashSelect(UINT32_C(0x36fcb308), UINT64_C(0x573f3d2e97212b34)),  DEE_PCKuSIZ "o", newsize, filler)));
	}
	...
	NONNULL_CXX((2)) void (insertall)(Dee_ssize_t index, DeeObject *seq) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "insertall", _Dee_HashSelect(UINT32_C(0xbf9bc3a9), UINT64_C(0x4f85971d093a27f2)),  DEE_PCKdSIZ "o", index, seq)));
	}
	NONNULL_CXX((2)) void (insertall)(size_t index, DeeObject *seq) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "insertall", _Dee_HashSelect(UINT32_C(0xbf9bc3a9), UINT64_C(0x4f85971d093a27f2)),  DEE_PCKuSIZ "o", index, seq)));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (erase)(DeeObject *index) {
		DeeObject *args[1];
		args[0] = index;
		return inherit(DeeObject_CallAttrStringHash(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)), 1, args));
	}
	WUNUSED NONNULL_CXX((1, 2)) Ref<deemon::int_> (erase)(DeeObject *index, DeeObject *count) {
		DeeObject *args[2];
		args[0] = index;
		args[1] = count;
		return inherit(DeeObject_CallAttrStringHash(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)), 2, args));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (erase)(DeeObject *index, Dee_ssize_t count) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)), "o" DEE_PCKdSIZ, index, count));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (erase)(DeeObject *index, size_t count) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)), "o" DEE_PCKuSIZ, index, count));
	}
	WUNUSED Ref<deemon::int_> (erase)(Dee_ssize_t index) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)),  DEE_PCKdSIZ, index));
	}
	WUNUSED NONNULL_CXX((2)) Ref<deemon::int_> (erase)(Dee_ssize_t index, DeeObject *count) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)),  DEE_PCKdSIZ "o", index, count));
	}
	WUNUSED Ref<deemon::int_> (erase)(Dee_ssize_t index, Dee_ssize_t count) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)),  DEE_PCKdSIZ DEE_PCKdSIZ, index, count));
	}
	WUNUSED Ref<deemon::int_> (erase)(Dee_ssize_t index, size_t count) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)),  DEE_PCKdSIZ DEE_PCKuSIZ, index, count));
	}
	WUNUSED Ref<deemon::int_> (erase)(size_t index) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)),  DEE_PCKuSIZ, index));
	}
	WUNUSED NONNULL_CXX((2)) Ref<deemon::int_> (erase)(size_t index, DeeObject *count) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)),  DEE_PCKuSIZ "o", index, count));
	}
	WUNUSED Ref<deemon::int_> (erase)(size_t index, Dee_ssize_t count) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)),  DEE_PCKuSIZ DEE_PCKdSIZ, index, count));
	}
	WUNUSED Ref<deemon::int_> (erase)(size_t index, size_t count) {
		return inherit(DeeObject_CallAttrStringHashf(this, "erase", _Dee_HashSelect(UINT32_C(0x6f5916cf), UINT64_C(0x65f9c8b6514af4e5)),  DEE_PCKuSIZ DEE_PCKuSIZ, index, count));
	}
	WUNUSED Ref<T> (pop)() {
	...
	WUNUSED Ref<T> (popfront)() {
		return inherit(DeeObject_CallAttrStringHash(this, "popfront", _Dee_HashSelect(UINT32_C(0x46523911), UINT64_C(0x22a469cc52318bba)), 0, NULL));
	}
	WUNUSED Ref<T> (popback)() {
		return inherit(DeeObject_CallAttrStringHash(this, "popback", _Dee_HashSelect(UINT32_C(0xd84577aa), UINT64_C(0xb77f74a49a9cc289)), 0, NULL));
	}
	void (reverse)() {
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "reverse", _Dee_HashSelect(UINT32_C(0xd8d820f4), UINT64_C(0x278cbcd3a230313a)), 0, NULL)));
	}
	void (sort)() {
	...
	NONNULL_CXX((1)) void (reserve)(DeeObject *size) {
		DeeObject *args[1];
		args[0] = size;
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "reserve", _Dee_HashSelect(UINT32_C(0x62fb4af5), UINT64_C(0x3a9a799f304cf8c9)), 1, args)));
	}
	void (reserve)(Dee_ssize_t size) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "reserve", _Dee_HashSelect(UINT32_C(0x62fb4af5), UINT64_C(0x3a9a799f304cf8c9)),  DEE_PCKdSIZ, size)));
	}
	void (reserve)(size_t size) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "reserve", _Dee_HashSelect(UINT32_C(0x62fb4af5), UINT64_C(0x3a9a799f304cf8c9)),  DEE_PCKuSIZ, size)));
	}
	void (shrink)() {
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "shrink", _Dee_HashSelect(UINT32_C(0xd8afa32b), UINT64_C(0xf4785bc46214dc5)), 0, NULL)));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (remove_if)(DeeObject *should) {
		DeeObject *args[1];
		args[0] = should;
		return inherit(DeeObject_CallAttrStringHash(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), 1, args));
	}
	WUNUSED NONNULL_CXX((1, 2)) Ref<deemon::int_> (remove_if)(DeeObject *should, DeeObject *start) {
		DeeObject *args[2];
		args[0] = should;
		args[1] = start;
		return inherit(DeeObject_CallAttrStringHash(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), 2, args));
	}
	WUNUSED NONNULL_CXX((1, 2, 3)) Ref<deemon::int_> (remove_if)(DeeObject *should, DeeObject *start, DeeObject *end) {
		...
		args[1] = start;
		args[2] = end;
		return inherit(DeeObject_CallAttrStringHash(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), 3, args));
	}
	WUNUSED NONNULL_CXX((1, 2)) Ref<deemon::int_> (remove_if)(DeeObject *should, DeeObject *start, Dee_ssize_t end) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "oo" DEE_PCKdSIZ, should, start, end));
	}
	WUNUSED NONNULL_CXX((1, 2)) Ref<deemon::int_> (remove_if)(DeeObject *should, DeeObject *start, size_t end) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "oo" DEE_PCKuSIZ, should, start, end));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (remove_if)(DeeObject *should, Dee_ssize_t start) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "o" DEE_PCKdSIZ, should, start));
	}
	WUNUSED NONNULL_CXX((1, 3)) Ref<deemon::int_> (remove_if)(DeeObject *should, Dee_ssize_t start, DeeObject *end) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "o" DEE_PCKdSIZ "o", should, start, end));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (remove_if)(DeeObject *should, Dee_ssize_t start, Dee_ssize_t end) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "o" DEE_PCKdSIZ DEE_PCKdSIZ, should, start, end));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (remove_if)(DeeObject *should, Dee_ssize_t start, size_t end) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "o" DEE_PCKdSIZ DEE_PCKuSIZ, should, start, end));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (remove_if)(DeeObject *should, size_t start) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "o" DEE_PCKuSIZ, should, start));
	}
	WUNUSED NONNULL_CXX((1, 3)) Ref<deemon::int_> (remove_if)(DeeObject *should, size_t start, DeeObject *end) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "o" DEE_PCKuSIZ "o", should, start, end));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (remove_if)(DeeObject *should, size_t start, Dee_ssize_t end) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "o" DEE_PCKuSIZ DEE_PCKdSIZ, should, start, end));
	}
	WUNUSED NONNULL_CXX((1)) Ref<deemon::int_> (remove_if)(DeeObject *should, size_t start, size_t end) {
		return inherit(DeeObject_CallAttrStringHashf(this, "remove_if", _Dee_HashSelect(UINT32_C(0x58aa20e7), UINT64_C(0x10d750b49732d559)), "o" DEE_PCKuSIZ DEE_PCKuSIZ, should, start, end));
	}
	NONNULL_CXX((1, 2)) void (insert_list)(DeeObject *index, DeeObject *items) {
		DeeObject *args[2];
		args[0] = index;
		args[1] = items;
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "insert_list", _Dee_HashSelect(UINT32_C(0xc36250ae), UINT64_C(0xef11d73d4bfae0f3)), 2, args)));
	}
	NONNULL_CXX((2)) void (insert_list)(Dee_ssize_t index, DeeObject *items) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "insert_list", _Dee_HashSelect(UINT32_C(0xc36250ae), UINT64_C(0xef11d73d4bfae0f3)),  DEE_PCKdSIZ "o", index, items)));
	}
	NONNULL_CXX((2)) void (insert_list)(size_t index, DeeObject *items) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "insert_list", _Dee_HashSelect(UINT32_C(0xc36250ae), UINT64_C(0xef11d73d4bfae0f3)),  DEE_PCKuSIZ "o", index, items)));
	}
	NONNULL_CXX((1, 2)) void (insert_iter)(DeeObject *index, DeeObject *iter) {
		DeeObject *args[2];
		args[0] = index;
		args[1] = iter;
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "insert_iter", _Dee_HashSelect(UINT32_C(0xb8d6666d), UINT64_C(0x6d19ee143161783f)), 2, args)));
	}
	NONNULL_CXX((2)) void (insert_iter)(Dee_ssize_t index, DeeObject *iter) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "insert_iter", _Dee_HashSelect(UINT32_C(0xb8d6666d), UINT64_C(0x6d19ee143161783f)),  DEE_PCKdSIZ "o", index, iter)));
	}
	NONNULL_CXX((2)) void (insert_iter)(size_t index, DeeObject *iter) {
		decref(throw_if_null(DeeObject_CallAttrStringHashf(this, "insert_iter", _Dee_HashSelect(UINT32_C(0xb8d6666d), UINT64_C(0x6d19ee143161783f)),  DEE_PCKuSIZ "o", index, iter)));
	}
	NONNULL_CXX((1)) void (push_front)(DeeObject *item) {
		DeeObject *args[1];
		args[0] = item;
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "push_front", _Dee_HashSelect(UINT32_C(0xdbec111), UINT64_C(0x9f0f5cc09fc9ec79)), 1, args)));
	}
	NONNULL_CXX((1)) void (push_back)(DeeObject *item) {
		DeeObject *args[1];
		args[0] = item;
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "push_back", _Dee_HashSelect(UINT32_C(0x9e3fe4f0), UINT64_C(0x4276b3cb4d87e17e)), 1, args)));
	}
	NONNULL_CXX((1)) void (pop_front)(DeeObject *item) {
		DeeObject *args[1];
		args[0] = item;
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "pop_front", _Dee_HashSelect(UINT32_C(0xbd2087a8), UINT64_C(0x3586ea08234c24c)), 1, args)));
	}
	NONNULL_CXX((1)) void (pop_back)(DeeObject *item) {
		DeeObject *args[1];
		args[0] = item;
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "pop_back", _Dee_HashSelect(UINT32_C(0x72cb762e), UINT64_C(0x379e1e780abd2dbc)), 1, args)));
	}
	void (shrink_to_fit)() {
		decref(throw_if_null(DeeObject_CallAttrStringHash(this, "shrink_to_fit", _Dee_HashSelect(UINT32_C(0xdc684938), UINT64_C(0x94741bfe350f497f)), 0, NULL)));
	}
	...
	public:
		...
		WUNUSED DREF DeeObject *_getref() const DEE_CXX_NOTHROW {
			return DeeObject_GetAttrStringHash(m_self, "allocated", _Dee_HashSelect(UINT32_C(0xf026a995), UINT64_C(0x5b116996dc9207df)));
		}
		WUNUSED bool bound() const {
			return throw_if_minusone(DeeObject_BoundAttrStringHash(m_self, "allocated", _Dee_HashSelect(UINT32_C(0xf026a995), UINT64_C(0x5b116996dc9207df))));
		}
		void del() const {
			throw_if_nonzero(DeeObject_DelAttrStringHash(m_self, "allocated", _Dee_HashSelect(UINT32_C(0xf026a995), UINT64_C(0x5b116996dc9207df))));
		}
		int _setref(DeeObject *value) const DEE_CXX_NOTHROW {
			return DeeObject_SetAttrStringHash(m_self, "allocated", _Dee_HashSelect(UINT32_C(0xf026a995), UINT64_C(0x5b116996dc9207df)), value);
		}
	};
