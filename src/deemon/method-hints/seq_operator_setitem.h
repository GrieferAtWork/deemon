...
seq_operator_setitem = {
	...
	if (SEQ_CLASS == Dee_SEQCLASS_SEQ && DeeType_RequireSetItem(THIS_TYPE))
		return THIS_TYPE->tp_seq->tp_setitem;
...
#ifndef LOCAL_FOR_OPTIMIZE
	if (SEQ_CLASS == Dee_SEQCLASS_SEQ && DeeType_RequireSetItemIndex(THIS_TYPE))
		return THIS_TYPE->tp_seq->tp_setitem_index;
#endif /* !LOCAL_FOR_OPTIMIZE */
