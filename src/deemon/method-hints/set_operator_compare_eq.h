...
[[operator([Set, Mapping].OPERATOR_EQ: tp_cmp->tp_compare_eq)]]
[[wunused]] int
...
[[operator([Set, Mapping].OPERATOR_EQ: tp_cmp->tp_trycompare_eq)]]
[[wunused]] int
...
[[operator([Set, Mapping].OPERATOR_EQ: tp_cmp->tp_eq)]]
...
[[operator([Set, Mapping].OPERATOR_NE: tp_cmp->tp_ne)]]
[[wunused]] DREF DeeObject *
