...
#include <deemon/dex.h>     /* Dee_DEXSYM_PROPERTY, Dee_DEXSYM_READONLY, Dee_dex_symbol, Dee_module_dexdata, _Dee_MODULE_DEXDATA_INIT_BUILDID, _Dee_MODULE_DEXDATA_INIT_BUILDTS */
#include <deemon/exec.h>    /* DeeExec_CompileModuleStream_impl, DeeExec_RUNMODE_DEFAULT */
#include <deemon/file.h>    /* DeeFile_OpenString, DeeFile_WriteAll, OPEN_F* */
...
dex_add_symbol(struct Dee_module_symbol *bucketv, uint16_t bucketm,
               struct Dee_dex_symbol const *sym, uint16_t index) {
