...
static void *const basic_targets[256] = {
    ...
    /* 0x08 */ &&unknown_instruction,
    /* 0x09 */ &&unknown_instruction,
    /* 0x0a */ &&unknown_instruction,
    /* 0x0b */ &&target_ASM_CALL_KW,
    /* 0x0c */ &&target_ASM_CALL_TUPLE_KW,
    /* 0x0d */ &&target_ASM_PUSH_BND_EXTERN,
    ...
    /* 0x2a */ &&target_ASM_SUPER_THIS_G,
    /* 0x2b */ &&target_ASM_SUPER_THIS_E,
    /* 0x2c */ &&target_ASM_POP_STATIC,
    /* 0x2d */ &&target_ASM_POP_EXTERN,
    ...
    /* 0x34 */ &&unknown_instruction,
    /* 0x35 */ &&unknown_instruction,
    /* 0x36 */ &&unknown_instruction,
    /* 0x37 */ &&unknown_instruction,
    /* 0x38 */ &&target_ASM_PUSH_MODULE,
    /* 0x39 */ &&target_ASM_PUSH_REF,
    /* 0x3a */ &&target_ASM_PUSH_ARG,
    /* 0x3b */ &&target_ASM_PUSH_CONST,
    /* 0x3c */ &&target_ASM_PUSH_STATIC,
    /* 0x3d */ &&target_ASM_PUSH_EXTERN,
    ...
    /* 0x62 */ &&target_ASM_CMP_LO,
    /* 0x63 */ &&target_ASM_CMP_LE,
    /* 0x64 */ &&target_ASM_CMP_GR,
    /* 0x65 */ &&target_ASM_CMP_GE,
    /* 0x66 */ &&target_ASM_CLASS,
    /* 0x67 */ &&target_ASM_CLASS_C,
    /* 0x68 */ &&target_ASM_CLASS_CBL,
    /* 0x69 */ &&target_ASM_CLASS_CBG,
    /* 0x6a */ &&target_ASM_DEFMEMBER,
    /* 0x6b */ &&target_ASM_DEFOP,
    ...
    /* 0xcf */ &&target_ASM_CALLATTR_TUPLE_C_KW,
    /* 0xd0 */ &&target_ASM_CALLATTR,
    /* 0xd1 */ &&target_ASM_CALLATTR_TUPLE,
    /* 0xd2 */ &&target_ASM_CALLATTR_C,
    /* 0xd3 */ &&target_ASM_CALLATTR_TUPLE_C,
    /* 0xd4 */ &&target_ASM_CALLATTR_THIS_C,
    /* 0xd5 */ &&target_ASM_CALLATTR_THIS_TUPLE_C,
    /* 0xd6 */ &&target_ASM_CALLATTR_C_SEQ,
    /* 0xd7 */ &&target_ASM_CALLATTR_C_MAP,
    /* 0xd8 */ &&unknown_instruction,
    /* 0xd9 */ &&target_ASM_GETMEMBER_R,
    /* 0xda */ &&target_ASM_DELMEMBER_R,
    /* 0xdb */ &&target_ASM_SETMEMBER_R,
    /* 0xdc */ &&target_ASM_BOUNDMEMBER_R,
    ...
    /* 0xfa */ &&unknown_instruction,
    /* 0xfb */ &&target_ASM_STACK,
    /* 0xfc */ &&target_ASM_STATIC,
    /* 0xfd */ &&target_ASM_EXTERN,
...
static void *const f0_targets[256] = {
    ...
    /* 0x09 */ &&unknown_instruction,
    /* 0x0a */ &&unknown_instruction,
    /* 0x0b */ &&target_ASM16_CALL_KW,
    /* 0x0c */ &&target_ASM16_CALL_TUPLE_KW,
    /* 0x0d */ &&target_ASM16_PUSH_BND_EXTERN,
    ...
    /* 0x2a */ &&target_ASM16_SUPER_THIS_G,
    /* 0x2b */ &&target_ASM16_SUPER_THIS_E,
    /* 0x2c */ &&target_ASM16_POP_STATIC,
    /* 0x2d */ &&target_ASM16_POP_EXTERN,
    /* 0x2e */ &&target_ASM16_POP_GLOBAL,
    /* 0x2f */ &&target_ASM16_POP_LOCAL,
    /* 0x30 */ &&unknown_instruction,
    /* 0x31 */ &&unknown_instruction,
    /* 0x32 */ &&unknown_instruction,
    /* 0x33 */ &&unknown_instruction,
    /* 0x34 */ &&target_ASM_PUSH_EXCEPT,
    /* 0x35 */ &&target_ASM_PUSH_THIS,
    /* 0x36 */ &&target_ASM_PUSH_THIS_MODULE,
    /* 0x37 */ &&target_ASM_PUSH_THIS_FUNCTION,
    /* 0x38 */ &&target_ASM16_PUSH_MODULE,
    /* 0x39 */ &&target_ASM16_PUSH_REF,
    /* 0x3a */ &&target_ASM16_PUSH_ARG,
    /* 0x3b */ &&target_ASM16_PUSH_CONST,
    /* 0x3c */ &&target_ASM16_PUSH_STATIC,
    /* 0x3d */ &&target_ASM16_PUSH_EXTERN,
    ...
    /* 0x64 */ &&unknown_instruction,
    /* 0x65 */ &&unknown_instruction,
    /* 0x66 */ &&unknown_instruction,
    /* 0x67 */ &&unknown_instruction,
    /* 0x68 */ &&unknown_instruction,
    /* 0x69 */ &&unknown_instruction,
    /* 0x6a */ &&target_ASM16_DEFMEMBER,
    /* 0x6b */ &&target_ASM16_DEFOP,
    /* 0x6c */ &&unknown_instruction,
    /* 0x6d */ &&unknown_instruction,
    /* 0x6e */ &&target_ASM16_FUNCTION_C,
    /* 0x6f */ &&target_ASM16_FUNCTION_C_16,
    /* 0x70 */ &&unknown_instruction,
    /* 0x71 */ &&unknown_instruction,
    /* 0x72 */ &&unknown_instruction,
    /* 0x73 */ &&unknown_instruction,
    ...
    /* 0xbe */ &&unknown_instruction,
    /* 0xbf */ &&unknown_instruction,
    /* 0xc0 */ &&unknown_instruction,
    /* 0xc1 */ &&unknown_instruction,
    /* 0xc2 */ &&unknown_instruction,
    /* 0xc3 */ &&unknown_instruction,
    /* 0xc4 */ &&unknown_instruction,
    /* 0xc5 */ &&unknown_instruction,
    /* 0xc6 */ &&target_ASM_GETMEMBER,
    /* 0xc7 */ &&target_ASM16_GETMEMBER,
    /* 0xc8 */ &&target_ASM_DELMEMBER,
    /* 0xc9 */ &&target_ASM16_DELMEMBER,
    /* 0xca */ &&target_ASM_SETMEMBER,
    /* 0xcb */ &&target_ASM16_SETMEMBER,
    /* 0xcc */ &&target_ASM_BOUNDMEMBER,
    /* 0xcd */ &&target_ASM16_BOUNDMEMBER,
    /* 0xce */ &&target_ASM16_CALLATTR_C_KW,
    /* 0xcf */ &&target_ASM16_CALLATTR_TUPLE_C_KW,
    /* 0xd0 */ &&target_ASM_CALLATTR_KWDS,
    /* 0xd1 */ &&target_ASM_CALLATTR_TUPLE_KWDS,
    /* 0xd2 */ &&target_ASM16_CALLATTR_C,
    /* 0xd3 */ &&target_ASM16_CALLATTR_TUPLE_C,
    /* 0xd4 */ &&target_ASM16_CALLATTR_THIS_C,
    /* 0xd5 */ &&target_ASM16_CALLATTR_THIS_TUPLE_C,
    /* 0xd6 */ &&target_ASM16_CALLATTR_C_SEQ,
    /* 0xd7 */ &&target_ASM16_CALLATTR_C_MAP,
    /* 0xd8 */ &&unknown_instruction,
    /* 0xd9 */ &&target_ASM16_GETMEMBER_R,
    /* 0xda */ &&target_ASM16_DELMEMBER_R,
    /* 0xdb */ &&target_ASM16_SETMEMBER_R,
    /* 0xdc */ &&target_ASM16_BOUNDMEMBER_R,
    ...
    /* 0xf9 */ &&unknown_instruction,
    /* 0xfa */ &&unknown_instruction,
    /* 0xfb */ &&target_ASM16_STACK,
    /* 0xfc */ &&target_ASM16_STATIC,
    /* 0xfd */ &&target_ASM16_EXTERN,
