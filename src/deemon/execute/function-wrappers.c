...
INTERN DeeTypeObject FrameStack_Type = {
	...
	/* .tp_gc            = */ NULL,
	/* .tp_math          = */ DEFIMPL(&default__tp_math__3959C0D1502AC76A),
	/* .tp_cmp           = */ DEFIMPL(&default__tp_cmp__DC202CECA797EF15),
...
PRIVATE struct type_seq framesymbolsbyname_seq = {
	...
	/* .tp_delitem_string_hash        = */ DEFIMPL(&default__delitem_string_hash__with__delitem), /* DEFAULT! */
	/* .tp_setitem_string_hash        = */ DEFIMPL(&default__setitem_string_hash__with__setitem), /* DEFAULT! */
