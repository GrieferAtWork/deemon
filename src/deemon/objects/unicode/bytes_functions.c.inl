...
INTERN struct type_method bytes_methods[] = {
	...
	{ "encode",
	  ...
	  TYPE_METHOD_FKWDS },
	{ "bytes",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_substr,
	  DOC("(start=!0,end=!-1)->?.\n"
	      "Same as #substr (here for ABI compatibility with :string.bytes)"),
	  TYPE_METHOD_FKWDS },
	{ "ord",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_ord,
	  DOC("->?Dint\n"
	...
	{ "resized",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_resized,
	  DOC("(new_size:?Dint,filler?:?Dint)->?.\n"
	      ...
	      "??\" */") },
	{ "reverse",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_reverse,
	  DOC("(start=!0,end=!-1)->?.\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "makereadonly",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_makereadonly,
	  DOC("->?.\n"
	...
	{ "makewritable",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_makewritable,
	  DOC("->?.\n"
	      ...
	      ">}") },
	{ "hex",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_hex,
	...
	{ "format",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_format,
	  DOC("(args:?S?O)->?.") },
	{ "scanf",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_scanf,
	  DOC("(format:?Dstring)->?S?O") },

	/* String/Character traits */
	{ "isprint",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isprint,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	...
	{ "isalpha",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isalpha,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "isspace",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isspace,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "islf",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_islf,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "islower",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_islower,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "isupper",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isupper,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "iscntrl",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_iscntrl,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "isdigit",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isdigit,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "isdecimal",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isdecimal,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "issymstrt",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_issymstrt,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "issymcont",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_issymcont,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "isalnum",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isalnum,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "isnumeric",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isnumeric,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "istitle",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_istitle,
	...
	{ "issymbol",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_issymbol,
	  DOC("(index:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	      "@throw IntegerOverflow The given @index is negative or too large\n"
	...
	{ "isascii",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isascii,
	  DOC("->?Dbool\n"
	      "(index:?Dint)->?Dbool\n"
	      "(start:?Dint,end:?Dint)->?Dbool\n"
	      "@throw IndexError The given @index is larger than ${#this}\n"
	...
	{ "asnumber",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_asnumber,
	  DOC("->?Dint\n"
	...
	{ "asdigit",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_asdigit,
	  DOC("->?Dint\n"
	      "@throw ValueError The string is longer than a single character\n"
	      "(index:?Dint)->?Dint\n"
	      "@throw ValueError The character at @index isn't numeric\n"
	...
	{ "asdecimal",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_asdecimal,
	  DOC("->?Dint\n"
	      "@throw ValueError The string is longer than a single character\n"
	      "(index:?Dint)->?Dint\n"
	      "@throw ValueError The character at @index isn't numeric\n"
	...
	{ "isanyprint",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanyprint,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is printable"),
	  TYPE_METHOD_FKWDS },
	{ "isanyalpha",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanyalpha,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is alphabetical"),
	  TYPE_METHOD_FKWDS },
	{ "isanyspace",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanyspace,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is a space character"),
	  TYPE_METHOD_FKWDS },
	{ "isanylf",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanylf,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is a line-feeds"),
	  TYPE_METHOD_FKWDS },
	{ "isanylower",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanylower,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is lower-case"),
	  TYPE_METHOD_FKWDS },
	{ "isanyupper",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanyupper,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is upper-case"),
	  TYPE_METHOD_FKWDS },
	{ "isanycntrl",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanycntrl,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is a control character"),
	  TYPE_METHOD_FKWDS },
	{ "isanydigit",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanydigit,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is a digit"),
	  TYPE_METHOD_FKWDS },
	{ "isanydecimal",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanydecimal,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is a dicimal character"),
	  TYPE_METHOD_FKWDS },
	{ "isanysymstrt",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanysymstrt,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} can be used to start a symbol name"),
	  TYPE_METHOD_FKWDS },
	{ "isanysymcont",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanysymcont,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} can be used to continue a symbol name"),
	  TYPE_METHOD_FKWDS },
	{ "isanyalnum",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanyalnum,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} is alpha-numerical"),
	  TYPE_METHOD_FKWDS },
	{ "isanynumeric",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanynumeric,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} qualifies as digit or decimal characters"),
	  TYPE_METHOD_FKWDS },
	{ "isanytitle",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanytitle,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	      "Returns :true if any character in "
	      "${this.substr(start,end)} has title-casing"),
	  TYPE_METHOD_FKWDS },
	{ "isanyascii",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_isanyascii,
	  DOC("(start=!0,end=!-1)->?Dbool\n"
	...
	{ DeeString_STR(&str_replace),
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_replace,
	  ...
	  TYPE_METHOD_FKWDS },
	{ "toreplace",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_toreplace,
	  DOC("(find:?X3?.?Dstring?Dint,replace:?X3?.?Dstring?Dint,max:?Dint=!A!Dint!PSIZE_MAX)->?.\n"
	      "@throw ValueError The given @find or @replace is a string containing characters ${> 0xff}\n"
	      "@throw IntegerOverflow The given @find or @replace is an integer lower than $0, or greater than $0xff\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "find",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_find,
	  ...
	  TYPE_METHOD_FKWDS },
	{ "rfind",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rfind,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dint\n"
	      "@throw ValueError The given @needle is a string containing characters ${> 0xff}\n"
	      "@throw IntegerOverflow The given @needle is an integer lower than $0, or greater than $0xff\n"
	      "Find the first instance of @needle that exists within ${this.substr(start,end)}, "
	  ...
	  TYPE_METHOD_FKWDS },
	{ "index",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_index,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dint\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "rindex",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rindex,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dint\n"
	      "@throw IndexError No instance of @needle can be found within ${this.substr(start,end)}\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "findall",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_findall,
	  ...
	  TYPE_METHOD_FKWDS },
	{ "count",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_count,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dint\n"
	      "Count the number of instances of @needle that exists within ${this.substr(start,end)}, "
	      "and return now many were found"),
	  TYPE_METHOD_FKWDS },
	{ "contains",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_contains_f,
	...
	{ "substr",
	  ...
	  TYPE_METHOD_FKWDS },
	{ "strip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_strip,
	...
	{ "lstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_lstrip,
	  DOC("(mask?:?X3?.?Dstring?Dint)->?.\n"
	      "Strip all leading whitespace-characters, or characters "
	      "apart of @mask, and return a sub-view of @this Bytes object") },
	{ "rstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rstrip,
	  DOC("(mask?:?X3?.?Dstring?Dint)->?.\n"
	      "Strip all trailing whitespace-characters, or characters "
	      "apart of @mask, and return a sub-view of @this Bytes object") },
	{ "sstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_sstrip,
	...
	{ "lsstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_lsstrip,
	  DOC("(other:?X3?.?Dstring?Dint)->?.\n"
	      ...
	      "> result = result[#other:];") },
	{ "rsstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rsstrip,
	  DOC("(other:?X3?.?Dstring?Dint)->?.\n"
	      ...
	      "> result = result[:#result-#other];") },
	{ "startswith",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_startswith,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dbool\n"
	      "Return :true if the sub-string ${this.substr(start,end)} starts with @other"),
	  TYPE_METHOD_FKWDS },
	{ "endswith",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_endswith,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dbool\n"
	      "Return :true if the sub-string ${this.substr(start,end)} ends with @other"),
	  TYPE_METHOD_FKWDS },
	{ "partition",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_parition,
	  ...
	  TYPE_METHOD_FKWDS },
	{ "rpartition",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rparition,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T3?.?.?.\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "compare",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_compare,
	...
	{ "vercompare",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_vercompare,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	...
	{ "wildcompare",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_wildcompare,
	...
	{ "fuzzycompare",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_fuzzycompare,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	...
	{ "wmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_wmatch,
	...
	{ "casereplace",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casereplace,
	  DOC("(find:?X3?.?Dstring?Dint,replace:?X3?.?Dstring?Dint,max:?Dint=!A!Dint!PSIZE_MAX)->?.\n"
	      "@throw ValueError The given @find or @replace is a string containing characters ${> 0xff}\n"
	      "@throw IntegerOverflow The given @find or @replace is an integer lower than $0, or greater than $0xff\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "tocasereplace",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_tocasereplace,
	  DOC("(find:?X3?.?Dstring?Dint,replace:?X3?.?Dstring?Dint,max:?Dint=!A!Dint!PSIZE_MAX)->?.\n"
	      "@throw ValueError The given @find or @replace is a string containing characters ${> 0xff}\n"
	      "@throw IntegerOverflow The given @find or @replace is an integer lower than $0, or greater than $0xff\n"
	      "@throw ValueError The number of bytes specified by @find and @replace are not identical\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "casefind",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casefind,
	  ...
	  TYPE_METHOD_FKWDS },
	{ "caserfind",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caserfind,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?X2?T2?Dint?Dint?N\n"
	      "@throw ValueError The given @needle is a string containing characters ${> 0xff}\n"
	      "@throw IntegerOverflow The given @needle is an integer lower than $0, or greater than $0xff\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "caseindex",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caseindex,
	  ...
	  TYPE_METHOD_FKWDS },
	{ "caserindex",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caserindex,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T2?Dint?Dint\n"
	      "@throw IndexError No instance of @needle can be found within ${this.substr(start,end)}\n"
	  ...
	  TYPE_METHOD_FKWDS },
	{ "casefindall",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casefindall,
	  ...
	  TYPE_METHOD_FKWDS },
	{ "casecount",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casecount,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dint\n"
	      "Same as #count, however ascii-casing is ignored during character comparisons"),
	  TYPE_METHOD_FKWDS },
	{ "casecontains",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casecontains_f,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dbool\n"
	      "Same as #contains, however ascii-casing is ignored during character comparisons"),
	  TYPE_METHOD_FKWDS },
	{ "casestrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casestrip,
	  DOC("(mask?:?X3?.?Dstring?Dint)->?.\n"
	      "Same as #strip, however ascii-casing is ignored during character comparisons") },
	{ "caselstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caselstrip,
	  DOC("(mask?:?X3?.?Dstring?Dint)->?.\n"
	      "Same as #lstrip, however ascii-casing is ignored during character comparisons") },
	{ "caserstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caserstrip,
	  DOC("(mask?:?X3?.?Dstring?Dint)->?.\n"
	      "Same as #rstrip, however ascii-casing is ignored during character comparisons") },
	{ "casesstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casesstrip,
	  DOC("(other:?X3?.?Dstring?Dint)->?.\n"
	      "Same as #sstrip, however ascii-casing is ignored during character comparisons") },
	{ "caselsstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caselsstrip,
	  DOC("(other:?X3?.?Dstring?Dint)->?.\n"
	      "Same as #lsstrip, however ascii-casing is ignored during character comparisons") },
	{ "casersstrip",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casersstrip,
	  DOC("(other:?X3?.?Dstring?Dint)->?.\n"
	      "Same as #rsstrip, however ascii-casing is ignored during character comparisons") },
	{ "casestartswith",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casestartswith,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dbool\n"
	      "Same as #startswith, however ascii-casing is ignored during character comparisons"),
	  TYPE_METHOD_FKWDS },
	{ "caseendswith",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caseendswith,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dbool\n"
	      "Same as #endswith, however ascii-casing is ignored during character comparisons"),
	  TYPE_METHOD_FKWDS },
	{ "casepartition",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caseparition,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T3?.?.?.\n"
	      "Same as #partition, however ascii-casing is ignored during character comparisons"),
	  TYPE_METHOD_FKWDS },
	{ "caserpartition",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caserparition,
	  DOC("(needle:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T3?.?.?.\n"
	      "Same as #rpartition, however ascii-casing is ignored during character comparisons"),
	  TYPE_METHOD_FKWDS },
	{ "casecompare",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casecompare,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "Same as #compare, however ascii-casing is ignored during character comparisons") },
	{ "casevercompare",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casevercompare,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "Same as #vercompare, however ascii-casing is ignored during character comparisons") },
	{ "casewildcompare",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casewildcompare,
	...
	{ "casefuzzycompare",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casefuzzycompare,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "Same as #fuzzycompare, however ascii-casing is ignored during character comparisons") },
	{ "casewmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casewmatch,
	  DOC("(pattern:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dbool\n"
	      "(my_start:?Dint,pattern:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dbool\n"
	      "(my_start:?Dint,my_end:?Dint,pattern:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dbool\n"
	...
	{ "center",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_center,
	...
	{ "ljust",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_ljust,
	...
	{ "rjust",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rjust,
	  DOC("(width:?Dint,filler=!P{ })->?.\n"
	      "Use a writable copy of @this Bytes object as result, then "
	      "insert @filler at the front to pad its length to @width bytes") },
	{ "zfill",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_zfill,
	...
	{ "reversed",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_reversed,
	  DOC("(start=!0,end=!-1)->?.\n"
	      "Return a copy of the sub-string ${this.substr(start,end)} with its byte order reversed"),
	  TYPE_METHOD_FKWDS },
	{ "expandtabs",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_expandtabs,
	  DOC("(tabwidth=!8)->?.\n"
	...
	{ "unifylines",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_unifylines,
	...
	{ "join",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_join,
	  DOC("(seq:?S?O)->?.\n"
	...
	{ "split",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_split,
	  DOC("(needle:?X3?.?Dstring?Dint)->?S?.\n"
	      ...
	      "memory") },
	{ "casesplit",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casesplit,
	  DOC("(needle:?X3?.?Dstring?Dint)->?S?.\n"
	      ...
	      "memory") },
	{ "splitlines",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_splitlines,
	  DOC("(keepends=!f)->?S?.\n"
	...
	/* String indentation. */
	{ "indent",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_indent,
	...
	{ "dedent",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_dedent,
	...
	{ "common",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_common,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	...
	{ "rcommon",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rcommon,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "Returns the number of common trailing bytes shared between @this and @other") },
	{ "casecommon",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casecommon,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "Same as #common, however ascii-casing is ignored during character comparisons") },
	{ "casercommon",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casercommon,
	  DOC("(other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	      "(my_start:?Dint,my_end:?Dint,other:?X2?.?Dstring,other_start=!0,other_end=!-1)->?Dint\n"
	...
	{ "findmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_findmatch,
	...
	{ "indexmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_indexmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dint\n"
	...
	{ "casefindmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casefindmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?X2?T2?Dint?Dint?N\n"
	      ...
	      "If no match if found, :none is returned") },
	{ "caseindexmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caseindexmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T2?Dint?Dint\n"
	      ...
	      "Upon success, the second returned integer is equal to ${return[0] + #close}") },
	{ "rfindmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rfindmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dint\n"
	...
	{ "rindexmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rindexmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?Dint\n"
	...
	{ "caserfindmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caserfindmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?X2?T2?Dint?Dint?N\n"
	      ...
	      "If no match if found, :none is returned") },
	{ "caserindexmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caserindexmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T2?Dint?Dint\n"
	      "@throw IndexError No instance of @open without a match @close exists within ${this.substr(start,end)}\n"
	...
	{ "partitionmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_partitionmatch,
	...
	{ "rpartitionmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_rpartitionmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T3?.?.?.\n"
	...
	{ "casepartitionmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_casepartitionmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T3?.?.?.\n"
	      "Same as #partitionmatch, however casing is ignored during character comparisons") },
	{ "caserpartitionmatch",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_caserpartitionmatch,
	  DOC("(open:?X3?.?Dstring?Dint,close:?X3?.?Dstring?Dint,start=!0,end=!-1)->?T3?.?.?.\n"
	      "Same as #rpartitionmatch, however casing is ignored during character comparisons") },

	{ "segments",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_segments,
	...
	{ "distribute",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_distribute,
	...
	{ "__sizeof__",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&bytes_sizeof,
	  DOC("->?Dint") },
