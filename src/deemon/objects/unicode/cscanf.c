...
#include <deemon/object.h>             /* ASSERT_OBJECT, DREF, DeeObject, DeeObject_*, DeeTypeObject, Dee_AsObject, Dee_COMPARE_ERR, Dee_Decref, Dee_Incref, Dee_Incref_n, Dee_hash_t, Dee_return_compareT, Dee_visit_t, ITER_DONE, ITER_ISOK, OBJECT_HEAD_INIT */
...
#include <deemon/type.h>               /* DeeObject_Init, DeeType_Type, STRUCT_OBJECT, TF_NONLOOPING, TP_FFINAL, TP_FNORMAL, TYPE_MEMBER*, type_* */
...
INTERN DeeTypeObject StringScanIterator_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&ssi_visit,
	/* .tp_gc            = */ NULL,
