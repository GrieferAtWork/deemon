 ...
 */
#ifndef GUARD_DEEMON_OBJECTS_UNICODE_BYTES_SEGMENTS_H
#define GUARD_DEEMON_OBJECTS_UNICODE_BYTES_SEGMENTS_H 1
...
#endif /* !GUARD_DEEMON_OBJECTS_UNICODE_BYTES_SEGMENTS_H */
