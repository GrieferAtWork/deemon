...
PRIVATE struct type_seq stringordinals_seq = {
	...
	/* .tp_bounditem          = */ NULL,
	/* .tp_hasitem            = */ NULL,
	/* .tp_size               = */ (size_t (DCALL *)(DeeObject *__restrict))&stringordinals_nsi_getsize,
	/* .tp_size_fast          = */ (size_t (DCALL *)(DeeObject *__restrict))&stringordinals_nsi_getsize,
	/* .tp_getitem_index      = */ (DREF DeeObject *(DCALL *)(DeeObject *, size_t))&stringordinals_nsi_getitem,
