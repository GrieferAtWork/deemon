    ...
    /* .tp_init = */{
        {
            /* .tp_alloc = */{
                ...
                /* .tp_free      = */NULL,
                {
                    /* .tp_instance_size = */sizeof(BytesSplitIterator)
                }
            }
        },
...
bs_init(BytesSplit *__restrict self, size_t argc,
 ...
 if (DeeBytes_Check(self->bs_sep_owner)) {
  ...
  if unlikely(!self->bs_sep_ptr) goto err;
    ...
    /* .tp_init = */{
        {
            /* .tp_alloc = */{
                ...
                /* .tp_free      = */NULL,
                {
                    /* .tp_instance_size = */sizeof(BytesSplit)
                }
            }
        },
...
DeeBytes_Split(Bytes *__restrict self,
 ...
 if (DeeString_Check(sep)) {
  ...
  if unlikely(!result->bs_sep_ptr) goto err_r;
...
PRIVATE struct type_getset blsi_getsets[] = {
    { "seq", (DREF DeeObject *(DCALL *)(DeeObject *__restrict))&blsi_getseq },
    { NULL }
};
    ...
    /* .tp_init = */{
        {
            /* .tp_alloc = */{
                ...
                /* .tp_free      = */NULL,
                {
                    /* .tp_instance_size = */sizeof(BytesLineSplitIterator)
                }
            }
        },
    ...
    /* .tp_init = */{
        {
            /* .tp_alloc = */{
                ...
                /* .tp_free      = */NULL,
                {
                    /* .tp_instance_size = */sizeof(BytesLineSplit)
                }
            }
        },
