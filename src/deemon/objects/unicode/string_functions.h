...
PRIVATE ATTR_PURE WUNUSED ATTR_INS(1, 2) ATTR_INS(3, 4) ATTR_INS(5, 6) uint8_t const *DCALL dee_find_casematchb(uint8_t const *scan_str, size_t scan_size, uint8_t const *open_str, size_t open_size, uint8_t const *clos_str, size_t clos_size);
PRIVATE ATTR_PURE WUNUSED ATTR_INS(1, 2) ATTR_INS(3, 4) ATTR_INS(5, 6) uint16_t const *DCALL dee_find_casematchw(uint16_t const *scan_str, size_t scan_size, uint16_t const *open_str, size_t open_size, uint16_t const *clos_str, size_t clos_size);
PRIVATE ATTR_PURE WUNUSED ATTR_INS(1, 2) ATTR_INS(3, 4) ATTR_INS(5, 6) uint32_t const *DCALL dee_find_casematchl(uint32_t const *scan_str, size_t scan_size, uint32_t const *open_str, size_t open_size, uint32_t const *clos_str, size_t clos_size);
...
PRIVATE ATTR_PURE WUNUSED ATTR_INS(1, 2) ATTR_INS(3, 4) ATTR_INS(5, 6) uint8_t const *DCALL dee_rfind_casematchb(uint8_t const *scan_str, size_t scan_size, uint8_t const *open_str, size_t open_size, uint8_t const *clos_str, size_t clos_size);
PRIVATE ATTR_PURE WUNUSED ATTR_INS(1, 2) ATTR_INS(3, 4) ATTR_INS(5, 6) uint16_t const *DCALL dee_rfind_casematchw(uint16_t const *scan_str, size_t scan_size, uint16_t const *open_str, size_t open_size, uint16_t const *clos_str, size_t clos_size);
PRIVATE ATTR_PURE WUNUSED ATTR_INS(1, 2) ATTR_INS(3, 4) ATTR_INS(5, 6) uint32_t const *DCALL dee_rfind_casematchl(uint32_t const *scan_str, size_t scan_size, uint32_t const *open_str, size_t open_size, uint32_t const *clos_str, size_t clos_size);
