...
PUBLIC DeeTypeObject DeeBytes_Type = {
	...
	/* .tp_doc      = */ DOC("An string-like abstract buffer object type for viewing & editing "
	                         ...
	                         "Whether or not a ?. object is read-only, or writable "
