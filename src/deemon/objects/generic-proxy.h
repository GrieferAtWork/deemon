...
#include <deemon/object.h> /* DREF, DeeObject, DeeTypeObject, Dee_AsObject, Dee_Decref, Dee_Decref_unlikely, Dee_Incref, Dee_foreach_pair_t, Dee_hash_t, Dee_ssize_t, OBJECT_HEAD */
...
printProxyObjectMethodHintWrapper("seq_erase");
printProxyObjectMethodHintWrapper("seq_reverse");
printProxyObjectMethodHintWrapper("set_operator_bool");
...
printProxyObjectMethodHintWrapper("set_boundfirst");
...
printProxyObjectMethodHintWrapper("iter_getindex");
printProxyObjectMethodHintWrapper("iter_setindex");
printProxyObjectMethodHintWrapper("iter_rewind");
printProxyObjectMethodHintWrapper("iter_advance");
printProxyObjectMethodHintWrapper("iter_revert");
]]]*/
...
INTDEF WUNUSED NONNULL((1)) int DCALL generic_proxy__seq_erase(ProxyObject *__restrict self, size_t index, size_t count); /* DeeObject_InvokeMethodHint(seq_erase, self->po_obj, index, count) */
INTDEF WUNUSED NONNULL((1)) int DCALL generic_proxy__seq_reverse(ProxyObject *self, size_t start, size_t end); /* DeeObject_InvokeMethodHint(seq_reverse, self->po_obj, start, end) */
INTDEF WUNUSED NONNULL((1)) int DCALL generic_proxy__set_operator_bool(ProxyObject *__restrict self); /* DeeObject_InvokeMethodHint(set_operator_bool, self->po_obj) */
...
INTDEF WUNUSED NONNULL((1)) int DCALL generic_proxy__set_boundfirst(ProxyObject *__restrict self); /* DeeObject_InvokeMethodHint(set_boundfirst, self->po_obj) */
...
INTDEF WUNUSED NONNULL((1)) size_t DCALL generic_proxy__iter_getindex(ProxyObject *__restrict self); /* DeeObject_InvokeMethodHint(iter_getindex, self->po_obj) */
INTDEF WUNUSED NONNULL((1)) int DCALL generic_proxy__iter_setindex(ProxyObject *self, size_t index); /* DeeObject_InvokeMethodHint(iter_setindex, self->po_obj, index) */
INTDEF WUNUSED NONNULL((1)) int DCALL generic_proxy__iter_rewind(ProxyObject *__restrict self); /* DeeObject_InvokeMethodHint(iter_rewind, self->po_obj) */
INTDEF WUNUSED NONNULL((1)) size_t DCALL generic_proxy__iter_advance(ProxyObject *__restrict self, size_t step); /* DeeObject_InvokeMethodHint(iter_advance, self->po_obj, step) */
INTDEF WUNUSED NONNULL((1)) size_t DCALL generic_proxy__iter_revert(ProxyObject *__restrict self, size_t step); /* DeeObject_InvokeMethodHint(iter_revert, self->po_obj, step) */
/*[[[end]]]*/
...
#define MyObject_DecrefSymbolic(self)      ProxyObject_DecrefSymbolic((DREF ProxyObject *)Dee_REQUIRES_TYPE(DREF MyObject *, self))
#endif
...
#define MyObject_DecrefSymbolic(self)              ProxyObject2_DecrefSymbolic((DREF ProxyObject2 *)Dee_REQUIRES_TYPE(DREF MyObject *, self))
#endif
...
#if 0
#define MyObject_New(obj1, obj2, obj3)                   ((DREF MyObject *)ProxyObject3_New(&MyObject_Type, Dee_AsObject(obj1), Dee_AsObject(obj2), Dee_AsObject(obj3)))
#define MyObject_NewInherited(obj1, obj2, obj3)          ((DREF MyObject *)ProxyObject3_NewInherited(&MyObject_Type, Dee_AsObject(obj1), Dee_AsObject(obj2), Dee_AsObject(obj3)))
#define MyObject_NewInherited1(obj1, obj2, obj3)         ((DREF MyObject *)ProxyObject3_NewInherited1(&MyObject_Type, Dee_AsObject(obj1), Dee_AsObject(obj2), Dee_AsObject(obj3)))
#define MyObject_NewInherited3(obj1, obj2, obj3)         ((DREF MyObject *)ProxyObject3_NewInherited3(&MyObject_Type, Dee_AsObject(obj1), Dee_AsObject(obj2), Dee_AsObject(obj3)))
#define MyObject_NewInheritedOnSuccess(obj1, obj2, obj3) ((DREF MyObject *)ProxyObject3_NewInheritedOnSuccess(&MyObject_Type, Dee_AsObject(obj1), Dee_AsObject(obj2), Dee_AsObject(obj3)))
#endif
LOCAL WUNUSED NONNULL((1, 2, 3, 4)) DREF DeeObject *DCALL
ProxyObject3_New(DeeTypeObject *tp, DeeObject *obj1, DeeObject *obj2, DeeObject *obj3) {
	DREF ProxyObject3 *result;
	result = DeeObject_MALLOC(ProxyObject3);
	if unlikely(!result)
		goto err;
	Dee_Incref(obj1);
	result->po_obj1 = obj1;
...
LOCAL WUNUSED NONNULL((1, 2, 3, 4)) DREF DeeObject *DCALL
ProxyObject3_NewInherited(DeeTypeObject *tp,
                          /*inherit(always)*/ DREF DeeObject *obj1,
                          /*inherit(always)*/ DREF DeeObject *obj2,
                          /*inherit(always)*/ DREF DeeObject *obj3) {
	DREF ProxyObject3 *result;
	result = DeeObject_MALLOC(ProxyObject3);
	if unlikely(!result)
		goto err;
...
ProxyObject3_NewInheritedOnSuccess(DeeTypeObject *tp,
                                   /*inherit(on_success)*/ DREF DeeObject *obj1,
                                   /*inherit(on_success)*/ DREF DeeObject *obj2,
                                   /*inherit(on_success)*/ DREF DeeObject *obj3) {
	DREF ProxyObject3 *result;
	result = DeeObject_MALLOC(ProxyObject3);
	if unlikely(!result)
		goto err;
