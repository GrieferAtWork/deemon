...
PRIVATE struct type_method object_methods[] = {
    ...
    { "id",              &object_id_method, DOC("()->int\n@return A unique id identifying this specific object instance") },
    /* Utility function: Return the size of a given object (in bytes) */
    { "__sizeof__",      &object_sizeof, DOC("()->int\n@return The size of @this object in bytes") },
    ...
    { meth_int+1,        &object_int },
    { meth_inv+1,        &object_inv },
    { meth_pos+1,        &object_pos },
    { meth_neg+1,        &object_neg },
    { meth_add+2,        &object_add },
    { meth_sub+2,        &object_sub },
    { meth_mul+2,        &object_mul },
    { meth_div+2,        &object_div },
    { meth_shl+2,        &object_shl },
    { meth_shr+2,        &object_shr },
    { meth_and+2,        &object_and },
    { meth_or+2,         &object_or },
    { meth_xor+2,        &object_xor },
    { meth_pow+2,        &object_pow },
    { meth_eq+2,         &object_eq },
    { meth_ne+2,         &object_ne },
    { meth_lo+2,         &object_lo },
    { meth_le+2,         &object_le },
    { meth_gr+2,         &object_gr },
    { meth_ge+2,         &object_ge },
    { meth_size+1,       &object_size },
    { meth_contains+2,   &object_contains },
    { meth_getitem+2,    &object_getitem },
    { meth_delitem+2,    &object_delitem },
    { meth_setitem+3,    &object_setitem },
    { meth_getrange+3,   &object_getrange },
    { meth_delrange+3,   &object_delrange },
    { meth_setrange+4,   &object_setrange },
    { meth_iterself+1,   &object_iterself },
    { meth_iternext+1,   &object_iternext },
    { meth_getattr+2,    &object_getattr },
    { meth_callattr,     &object_callattr },
    { meth_hasattr+2,    &object_hasattr },
    { meth_delattr+2,    &object_delattr },
    { meth_setattr+3,    &object_setattr },
