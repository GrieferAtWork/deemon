...
#include <deemon/type.h>               /* DeeObject_Init, DeeTypeMRO, DeeTypeMRO_Init, DeeTypeMRO_Next, DeeType_IsClass, DeeType_Type, METHOD_F*, OPERATOR_*, STRUCT_OBJECT, TF_NONE, TP_FNAMEOBJECT, TP_FNORMAL, TYPE_*, type_* */
