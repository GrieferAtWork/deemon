...
#include <deemon/object.h>             /* DREF, DeeObject, DeeObject_*, DeeTypeObject, Dee_AsObject, Dee_COMPARE_ERR, Dee_Decref*, Dee_HAS_*, Dee_Incref, Dee_Incref_n, Dee_XDecref, Dee_foreach_pair_t, Dee_foreach_t, Dee_ssize_t, ITER_DONE, ITER_ISOK, OBJECT_HEAD_INIT */
...
INTERN DeeTypeObject SeqFlat_Type = {
	...
	/* .tp_cmp           = */ DEFIMPL(&default__tp_cmp__0580A1030F1E6143),
	/* .tp_seq           = */ &sf_seq,
