...
#include <deemon/type.h>               /* DeeObject_Init, DeeObject_IsShared, DeeType_Type, Dee_TYPE_CONSTRUCTOR_INIT_VAR, Dee_Visitv, STRUCT_OBJECT, STRUCT_SIZE_T, TF_NONE, TP_F*, TYPE_*, type_* */
