...
#include <deemon/type.h>               /* DeeObject_Init, DeeType_Type, Dee_TYPE_CONSTRUCTOR_INIT_FIXED, Dee_Visit, STRUCT_OBJECT, TF_NONE, TP_FNORMAL, TYPE_MEMBER_END, TYPE_MEMBER_FIELD_DOC, type_attr, type_member */
...
INTERN DeeTypeObject MapByAttr_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&byattr_visit,
	/* .tp_gc            = */ NULL,
...
MapByAttr_Of(DeeObject *__restrict map) {
	return Dee_AsObject(MapByAttr_New(map));
}
