...
INTDEF WUNUSED DREF DeeObject *DCALL DeeSeqEach_CallAttr(DeeObject *__restrict self, DeeObject *__restrict attr, size_t argc, DeeObject **argv);
INTDEF WUNUSED DREF DeeObject *DCALL DeeSeqEach_CallAttrString(DeeObject *__restrict self, char const *__restrict attr, dhash_t hash, size_t argc, DeeObject **argv);
INTDEF WUNUSED DREF DeeObject *DCALL DeeSeqEach_CallAttrStringLen(DeeObject *__restrict self, char const *__restrict attr, size_t attrlen, dhash_t hash, size_t argc, DeeObject **argv);
INTDEF WUNUSED DREF DeeObject *DCALL DeeSeqEach_CallAttrKw(DeeObject *__restrict self, DeeObject *__restrict attr, size_t argc, DeeObject **argv, DeeObject *kw);
INTDEF WUNUSED DREF DeeObject *DCALL DeeSeqEach_CallAttrStringKw(DeeObject *__restrict self, char const *__restrict attr, dhash_t hash, size_t argc, DeeObject **argv, DeeObject *kw);
INTDEF WUNUSED DREF DeeObject *DCALL DeeSeqEach_CallAttrStringLenKw(DeeObject *__restrict self, char const *__restrict attr, size_t attrlen, dhash_t hash, size_t argc, DeeObject **argv, DeeObject *kw);
