...
#include <deemon/arg.h>                /* DeeArg_Unpack1, DeeArg_UnpackStruct2X, UNPuN, _DeeArg_AsObject */
#include <deemon/computed-operators.h> /* DEFIMPL, DEFIMPL_UNSUPPORTED */
#include <deemon/object.h>             /* DREF, DeeObject, DeeObject_*, DeeTypeObject, Dee_AsObject, Dee_COMPARE_ERR, Dee_COMPARE_NE, Dee_Decref, Dee_DecrefNokill, Dee_Incref, Dee_SIZEOF_HASH_T, Dee_TYPE, Dee_hash_t, ITER_ISOK, OBJECT_HEAD_INIT, return_reference_ */
