...
#include <deemon/object.h>             /* DREF, DeeObject, DeeObject_*, DeeTypeObject, Dee_AsObject, Dee_Decref, Dee_DecrefNokill, Dee_Incref, Dee_TYPE, Dee_foreach_t, Dee_ssize_t, ITER_ISOK, OBJECT_HEAD_INIT, return_reference_ */
#include <deemon/seq.h>                /* DeeIterator_Type, DeeSeq_NewEmpty, DeeSeq_Type, Dee_EmptySeq */
#include <deemon/type.h>               /* DeeType_GetName, DeeType_Type, Dee_TYPE_CONSTRUCTOR_INIT_FIXED, Dee_visit_t, METHOD_FNOREFESCAPE, STRUCT_OBJECT_AB, TF_NONE, TP_FFINAL, TP_FNORMAL, TYPE_*, type_* */
...
PRIVATE struct type_member tpconst proxy_members[] = {
	TYPE_MEMBER_FIELD_DOC("__seq__", STRUCT_OBJECT_AB, offsetof(SeqSimpleProxy, sp_seq), "->?DSequence"),
	TYPE_MEMBER_END
};

PRIVATE WUNUSED NONNULL((1)) DREF SeqSimpleProxyIterator *DCALL ids_iter(SeqSimpleProxy *__restrict self);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL ids_getitem(SeqSimpleProxy *__restrict self, DeeObject *index);
PRIVATE WUNUSED NONNULL((1)) DREF DeeObject *DCALL ids_getitem_index(SeqSimpleProxy *__restrict self, size_t index);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL ids_trygetitem(SeqSimpleProxy *__restrict self, DeeObject *index);
PRIVATE WUNUSED NONNULL((1)) DREF DeeObject *DCALL ids_trygetitem_index(SeqSimpleProxy *__restrict self, size_t index);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL ids_contains(SeqSimpleProxy *self, DeeObject *value);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL ids_foreach(SeqSimpleProxy *self, Dee_foreach_t proc, void *arg);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL ids_mh_seq_enumerate(SeqSimpleProxy *self, Dee_seq_enumerate_t proc, void *arg);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL ids_mh_seq_enumerate_index(SeqSimpleProxy *self, Dee_seq_enumerate_index_t proc, void *arg, size_t start, size_t end);

PRIVATE WUNUSED NONNULL((1)) DREF SeqSimpleProxyIterator *DCALL types_iter(SeqSimpleProxy *__restrict self);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL types_getitem(SeqSimpleProxy *__restrict self, DeeObject *index);
PRIVATE WUNUSED NONNULL((1)) DREF DeeObject *DCALL types_getitem_index(SeqSimpleProxy *__restrict self, size_t index);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL types_trygetitem(SeqSimpleProxy *__restrict self, DeeObject *index);
PRIVATE WUNUSED NONNULL((1)) DREF DeeObject *DCALL types_trygetitem_index(SeqSimpleProxy *__restrict self, size_t index);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL types_contains(SeqSimpleProxy *self, DeeObject *value);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL types_foreach(SeqSimpleProxy *self, Dee_foreach_t proc, void *arg);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL types_mh_seq_enumerate(SeqSimpleProxy *self, Dee_seq_enumerate_t proc, void *arg);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL types_mh_seq_enumerate_index(SeqSimpleProxy *self, Dee_seq_enumerate_index_t proc, void *arg, size_t start, size_t end);

PRIVATE WUNUSED NONNULL((1)) DREF SeqSimpleProxyIterator *DCALL classes_iter(SeqSimpleProxy *__restrict self);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL classes_getitem(SeqSimpleProxy *__restrict self, DeeObject *index);
PRIVATE WUNUSED NONNULL((1)) DREF DeeObject *DCALL classes_getitem_index(SeqSimpleProxy *__restrict self, size_t index);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL classes_trygetitem(SeqSimpleProxy *__restrict self, DeeObject *index);
PRIVATE WUNUSED NONNULL((1)) DREF DeeObject *DCALL classes_trygetitem_index(SeqSimpleProxy *__restrict self, size_t index);
PRIVATE WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL classes_contains(SeqSimpleProxy *self, DeeObject *value);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL classes_foreach(SeqSimpleProxy *self, Dee_foreach_t proc, void *arg);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL classes_mh_seq_enumerate(SeqSimpleProxy *self, Dee_seq_enumerate_t proc, void *arg);
PRIVATE WUNUSED NONNULL((1, 2)) Dee_ssize_t DCALL classes_mh_seq_enumerate_index(SeqSimpleProxy *self, Dee_seq_enumerate_index_t proc, void *arg, size_t start, size_t end);
#ifndef __INTELLISENSE__
DECL_END
#define DEFINE_Sequence_ids
#include "simpleproxy-impl.c.inl"
...
PRIVATE struct type_member tpconst iter_members[] = {
	TYPE_MEMBER_FIELD_DOC("__iter__", STRUCT_OBJECT_AB, offsetof(SeqSimpleProxyIterator, si_iter), "->?DIterator"),
	TYPE_MEMBER_END
};
