...
#include <deemon/alloc.h>              /* DeeObject_MALLOC, Dee_Free, Dee_Mallocc, Dee_TYPE_CONSTRUCTOR_INIT_FIXED, Dee_TryMallocc */
...
#include <deemon/object.h>             /* DREF, DeeObject, DeeObject_*, DeeTypeObject, Dee_AsObject, Dee_BOUND_*, Dee_COMPARE_GR, Dee_COMPARE_LO, Dee_Compare, Dee_Decref*, Dee_Incref, Dee_Movrefv, Dee_OBJECT_HEAD, Dee_TYPE, Dee_XDecref*, Dee_XIncref, Dee_XMovrefv, Dee_foreach_t, Dee_ssize_t, ITER_DONE, ITER_ISOK, OBJECT_HEAD_INIT, return_reference_ */
...
PRIVATE struct type_method tpconst cswiiter_methods[] = {
	TYPE_METHOD_HINTREF(Iterator_advance),
	TYPE_METHOD_END
};

PRIVATE struct type_method_hint tpconst cswiiter_method_hints[] = {
	TYPE_METHOD_HINT(iter_advance, &cswiiter_advance),
...
INTERN DeeTypeObject CachedSeq_WithIter_Iterator_Type = {
	...
	/* .tp_with          = */ DEFIMPL_UNSUPPORTED(&default__tp_with__0476D7EDEFD2E7B7),
	/* .tp_buffer        = */ NULL,
	/* .tp_methods       = */ cswiiter_methods,
	/* .tp_getsets       = */ NULL,
	/* .tp_members       = */ cswiiter_members,
	/* .tp_class_methods = */ NULL,
	/* .tp_class_getsets = */ NULL,
	/* .tp_class_members = */ NULL,
	/* .tp_method_hints  = */ cswiiter_method_hints,
