...
PUBLIC DeeTypeObject DeeSeq_Type = {
    ...
    /* .tp_doc      = */DOC("A recommended abstract base class for any sequence "
                            ...
                            "Also note that a sequence may also become mutable by implementing "
                            "${operator []=} (setitem) and/or ${operator [:]=} (setrange), at which "
                            "point an extended set of sequence functionality become available for use.\n"
                            ...
                            "strategy used, based on what operators have been implemented by sub-classes, as well "
                            ...
                            "> count = (int)count;\n"
                            "> if (count < 0)\n"
                            ">  throw Error.ValueError.Arithmetic.IntegerOverflow();\n"
                            "> while (count) {\n"
                            ">  --count;\n"
                            ">  yield this...;\n"
                            "> }\n"
                            ...
                            ">   return this;\n"
                            ">  }\n"
                            ">  if (tp.hasoperator(this,\"setrange\")) {\n"
                            ">   this[int.SIZE_MAX:int.SIZE_MAX] = items;\n"
                            ">   return this;\n"
                            ">  }\n"
                            ">  if (tp.hasattribute(\"append\")) {\n"
