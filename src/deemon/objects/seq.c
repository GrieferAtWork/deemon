...
INTERN_TPCONST struct type_method tpconst seq_methods[] = {
	...
	TYPE_KWMETHOD(DeeMA_Sequence_any_name, &DeeMA_Sequence_any,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_any__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_any__();}&"
	              /**/ "${function any(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.any();}&"
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_any__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_any__(0, int.SIZE_MAX, key);}&"
	              /**/ "${function any(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.any(0, int.SIZE_MAX, key);}&"
	              /**/ "?#{op:iter}" /*                                                          */ "|${"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this)) {\n"
	              /**/ /**/ "	if (key(item))\n"
	              /**/ /**/ "		return true;\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_any__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_any__(start, end);}&"
	              /**/ "${function any(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.any(start, end);}&"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_any__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_any__(start, end, key);}&"
	              /**/ "${function any(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.any(start, end, key);}&"
	              /**/ "?#__enumerate__" /*                                                      */ "|${"
	              /**/ /**/ "return this.__enumerate__((i, item?) -\\> {\n"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_all_name, &DeeMA_Sequence_all,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_all__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_all__();}&"
	              /**/ "${function all(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.all();}&"
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_all__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_all__(0, int.SIZE_MAX, key);}&"
	              /**/ "${function all(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.all(0, int.SIZE_MAX, key);}&"
	              /**/ "?#{op:iter}" /*                                                          */ "|${"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this)) {\n"
	              /**/ /**/ "	if (!key(item))\n"
	              /**/ /**/ "		return false;\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_all__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_all__(start, end);}&"
	              /**/ "${function all(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.all(start, end);}&"
	              /**/ "?A__seqclass__?DType is ?DMapping" /*                      */ "|${"
	              /**/ /**/ "/* Mappings are made up of non-empty (2-element) tuples, so they can never\n"
	              /**/ /**/ " * have items (the 2-element tuples) that evaluate to \"false\". As such, the\n"
	              /**/ /**/ " * Sequence.all() operator for mappings can return a constant \"true\". */\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_all__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_all__(start, end, key);}&"
	              /**/ "${function all(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.all(start, end, key);}&"
	              /**/ "?#__enumerate__" /*                                                      */ "|${"
	              /**/ /**/ "return this.__enumerate__((i, item?) -\\> {\n"
	              /**/ /**/ "	if (item is bound && !key(item))\n"
	              /**/ /**/ "		return false;\n"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_parity_name, &DeeMA_Sequence_parity,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_parity__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_parity__();}&"
	              /**/ "${function parity(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.parity();}&"
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_parity__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_parity__(0, int.SIZE_MAX, key);}&"
	              /**/ "${function parity(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.parity(0, int.SIZE_MAX, key);}&"
	              /**/ "?#{op:iter}" /*                                                          */ "|${"
	              /**/ /**/ "local result = false;\n"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this)) {\n"
	              /**/ /**/ "	if (key(item))\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_parity__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_parity__(start, end);}&"
	              /**/ "${function parity(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.parity(start, end);}&"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_parity__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_parity__(start, end, key);}&"
	              /**/ "${function parity(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.parity(start, end, key);}&"
	              /**/ "?#__enumerate__" /*                                                      */ "|${"
	              /**/ /**/ "local result = Cell(false);\n"
	              /**/ /**/ "return this.__enumerate__((i, item?) -\\> {\n"
	              /**/ /**/ "	if (item is bound && key(item))\n"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_reduce_name, &DeeMA_Sequence_reduce,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && init !is bound}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_reduce__(combine: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object}" /*                     */ "|${return this.__seq_reduce__(combine);}&"
	              /**/ "${function reduce(combine: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.reduce(combine);}&"
	              /**/ "?#{op:iter}" /**/ "|${"
	              /**/ /**/ "local result;\n"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this))\n"
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && init is bound}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_reduce__(combine: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object}" /*                     */ "|${return this.__seq_reduce__(combine, 0, int.SIZE_MAX, init);}&"
	              /**/ "${function reduce(combine: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.reduce(combine, 0, int.SIZE_MAX, init);}&"
	              /**/ "?#{op:iter}" /**/ "|${"
	              /**/ /**/ "local result = init;\n"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this))\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && init !is bound}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_reduce__(combine: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object}" /*                     */ "|${return this.__seq_reduce__(combine, start, end);}&"
	              /**/ "${function reduce(combine: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.reduce(combine, start, end);}&"
	              /**/ "?#__enumerate__" /**/ "|${"
	              /**/ /**/ "local result = Cell();\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && init is bound}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_reduce__(combine: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object}" /*                     */ "|${return this.__seq_reduce__(combine, start, end, init);}&"
	              /**/ "${function reduce(combine: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.reduce(combine, start, end, init);}&"
	              /**/ "?#__enumerate__" /**/ "|${"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_min_name, &DeeMA_Sequence_min,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_min__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object}" /*                     */ "|${return this.__seq_min__();}&"
	              /**/ "${function min(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.min();}&"
	              /**/ "?#{op:iter}" /*                                                          */ "|${"
	              /**/ /**/ "local result;\n"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this)) {\n"
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_min__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object}" /*                     */ "|${return this.__seq_min__(0, int.SIZE_MAX, key);}&"
	              /**/ "${function min(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.min(0, int.SIZE_MAX, key);}&"
	              /**/ "?#{op:iter}" /*                                                          */ "|${"
	              /**/ /**/ "local result;\n"
	              /**/ /**/ "local keyedResult;\n"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this)) {\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_min__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object}" /*                     */ "|${return this.__seq_min__(start, end);}&"
	              /**/ "${function min(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.min(start, end);}&"
	              /**/ "?#__enumerate__" /*                                                     */ "|${"
	              /**/ /**/ "local result = Cell();\n"
	              /**/ /**/ "this.__enumerate__((i, item?) -\\> {\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_min__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object}" /*                     */ "|${return this.__seq_min__(start, end, key);}&"
	              /**/ "${function min(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.min(start, end, key);}&"
	              /**/ "?#__enumerate__" /*                                                      */ "|${"
	              /**/ /**/ "local result = Cell();\n"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_max_name, &DeeMA_Sequence_max,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_max__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object}" /*                     */ "|${return this.__seq_max__();}&"
	              /**/ "${function max(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.max();}&"
	              /**/ "?#{op:iter}" /*                                                          */ "|${"
	              /**/ /**/ "local result;\n"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this)) {\n"
	              /**/ /**/ "	if (result !is bound || !(result > item))\n"
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_max__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object}" /*                     */ "|${return this.__seq_max__(0, int.SIZE_MAX, key);}&"
	              /**/ "${function max(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.max(0, int.SIZE_MAX, key);}&"
	              /**/ "?#{op:iter}" /*                                                          */ "|${"
	              /**/ /**/ "local result;\n"
	              /**/ /**/ "local keyedResult;\n"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this)) {\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_max__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object}" /*                     */ "|${return this.__seq_max__(start, end);}&"
	              /**/ "${function max(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.max(start, end);}&"
	              /**/ "?#__enumerate__" /*                                                     */ "|${"
	              /**/ /**/ "local result = Cell();\n"
	              /**/ /**/ "this.__enumerate__((i, item?) -\\> {\n"
	              /**/ /**/ "	if (item is bound && (result.value !is bound || !(result.value > item)))\n"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_max__(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object}" /*                     */ "|${return this.__seq_max__(start, end, key);}&"
	              /**/ "${function max(start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.max(start, end, key);}&"
	              /**/ "?#__enumerate__" /*                                                      */ "|${"
	              /**/ /**/ "local result = Cell();\n"
	              /**/ /**/ "local keyedResult = Cell();\n"
	              /**/ /**/ "this.__enumerate__((i, item?) -\\> {\n"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_sum_name, &DeeMA_Sequence_sum,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_sum__(start: int = 0, end: int = int.SIZE_MAX): Object}" /*                     */ "|${return this.__seq_sum__();}&"
	              /**/ "${function sum(start: int = 0, end: int = int.SIZE_MAX): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.sum();}&"
	              /**/ "?#{op:iter}" /*                                                          */ "|${"
	              /**/ /**/ "local result;\n"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this))\n"
	              ...
	              "When ${start != 0 || end != int.SIZE_MAX}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_sum__(start: int = 0, end: int = int.SIZE_MAX): Object}" /*                     */ "|${return this.__seq_sum__(start, end);}&"
	              /**/ "${function sum(start: int = 0, end: int = int.SIZE_MAX): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.sum(start, end);}&"
	              /**/ "?#__enumerate__" /*                                                     */ "|${"
	              /**/ /**/ "local result = Cell();\n"
	              /**/ /**/ "this.__enumerate__((i, item?) -\\> {\n"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_count_name, &DeeMA_Sequence_count,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_count__(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): int}" /*                     */ "|${return this.__seq_count__(item).operator int();}&"
	              /**/ "${function count(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): int} (?A__seqclass__?DType is ?.)" /**/ "|${return this.count(item).operator int();}&"
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_count__(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): int}" /*                     */ "|${return this.__seq_count__(item, 0, int.SIZE_MAX, key);}&"
	              /**/ "${function count(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): int} (?A__seqclass__?DType is ?.)" /**/ "|${return this.count(item, 0, int.SIZE_MAX, key);}&"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_count__(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): int}" /*                     */ "|${return this.__seq_count__(item, start, end);}&"
	              /**/ "${function count(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): int} (?A__seqclass__?DType is ?.)" /**/ "|${return this.count(item, start, end);}&"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_count__(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): int}" /*                     */ "|${return this.__seq_count__(item, start, end, key);}&"
	              /**/ "${function count(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): int} (?A__seqclass__?DType is ?.)" /**/ "|${return this.count(item, start, end, key);}&"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_contains_name, &DeeMA_Sequence_contains,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_contains__(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_contains__(item);}&"
	              /**/ "${function contains(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.contains(item);}&"
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_contains__(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_contains__(item, 0, int.SIZE_MAX, key);}&"
	              /**/ "${function contains(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.contains(item, 0, int.SIZE_MAX, key);}&"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_contains__(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_contains__(item, start, end);}&"
	              /**/ "${function contains(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.contains(item, start, end);}&"
	              ...
	              "When ${(start != 0 || end != int.SIZE_MAX) && key !is none}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_contains__(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool}" /*                     */ "|${return this.__seq_contains__(item, start, end, key);}&"
	              /**/ "${function contains(item: Object, start: int = 0, end: int = int.SIZE_MAX, key: Callable | none = none): bool} (?A__seqclass__?DType is ?.)" /**/ "|${return this.contains(item, start, end, key);}&"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_locate_name, &DeeMA_Sequence_locate,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_locate__(match: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object}" /*                     */ "|${return this.__seq_locate__(match, 0, int.SIZE_MAX, def);}&"
	              /**/ "${function locate(match: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.locate(match, 0, int.SIZE_MAX, def);}&"
	              /**/ "?#{op:iter}" /**/ "|${"
	              /**/ /**/ "foreach (local item: Sequence.__iter__(this)) {\n"
	              /**/ /**/ "	if (match(item))\n"
	              /**/ /**/ "		return item;\n"
	              ...
	              "When ${start != 0 || end != int.SIZE_MAX}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_locate__(match: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object}" /*                     */ "|${return this.__seq_locate__(match, start, end, def);}&"
	              /**/ "${function locate(match: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.locate(match, start, end, def);}&"
	              /**/ "?#__enumerate__" /**/ "|${"
	...
	TYPE_KWMETHOD(DeeMA_Sequence_rlocate_name, &DeeMA_Sequence_rlocate,
	              ...
	              "When ${start == 0 && end == int.SIZE_MAX}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_rlocate__(match: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object}" /*                     */ "|${return this.__seq_rlocate__(match, 0, int.SIZE_MAX, def);}&"
	              /**/ "${function rlocate(match: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.rlocate(match, 0, int.SIZE_MAX, def);}&"
	              /**/ "?#__iter_reverse__" /**/ "|${"
	              ...
	              "When ${start != 0 || end != int.SIZE_MAX}:"
	              "#T{Requirements|Implementation~"
	              /**/ "${function __seq_rlocate__(match: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object}" /*                     */ "|${return this.__seq_rlocate__(match, start, end, def);}&"
	              /**/ "${function rlocate(match: Callable, start: int = 0, end: int = int.SIZE_MAX, init?: Object): Object} (?A__seqclass__?DType is ?.)" /**/ "|${return this.rlocate(match, start, end, def);}&"
	...
	TYPE_METHOD("__enumerate__", &DeeMA___seq_enumerate__,
	            ...
	            "When ${start == 0 && end == int.SIZE_MAX}:"
	            "#T{Requirements|Implementation~"
	            /**/ "${function __seq_enumerate__(cb: Callable, start: int = 0, end: int = int.SIZE_MAX): Object | none}" /**/ "|${return this.__seq_enumerate__(cb);}&"
	            /**/ "?#{op:getitem}, ?#{op:size}" /**/ "|${"
	            ...
	            "When ${start != 0 || end != int.SIZE_MAX}:"
	            "#T{Requirements|Implementation~"
	            /**/ "${function __seq_enumerate__(cb: Callable, start: int = 0, end: int = int.SIZE_MAX): Object | none}" /**/ "|${return this.__seq_enumerate__(cb, start, end);}&"
	            /**/ "?#{op:getitem}, ?#{op:size}" /**/ "|${"
	...
	TYPE_METHOD("__enumerate_items__", &DeeMA___seq_enumerate_items__,
	            ...
	            "When ${start == 0 && end == int.SIZE_MAX}:"
	            "#T{Requirements|Implementation~"
	            /**/ "${function __seq_enumerate_items__(start: int = 0, end: int = int.SIZE_MAX): {(int, Object)...}}" /**/ "|${return this.__seq_enumerate_items__();}&"
	            /**/ "?#{op:getitem}, ?#{op:size}" /**/ "|${"
	            /**/ /**/ "for (local i: [:Sequence.__size__(this)]) {\n"
	            /**/ /**/ "	local item;\n"
	            /**/ /**/ "	try {\n"
	            ...
	            "When ${start != 0 || end != int.SIZE_MAX}:"
	            "#T{Requirements|Implementation~"
	            /**/ "${function __seq_enumerate_items__(start: int = 0, end: int = int.SIZE_MAX): Object | none}" /**/ "|${return this.__seq_enumerate_items__(start, end);}&"
	            /**/ "?#{op:getitem}, ?#{op:size}" /**/ "|${"
	            /**/ /**/ "local size = Sequence.__size__(this);\n"
	            /**/ /**/ "if (end > size)\n"
	            /**/ /**/ "	end = size;\n"
