...
DeeRoDict_GetItemNRDef(DeeRoDictObject *self, DeeObject *key, DeeObject *def) {
	size_t i, perturb, hash;
	struct rodict_item *item;
	hash     = DeeObject_Hash(key);
...
DeeRoDict_GetItemNRStringHashDef(DeeRoDictObject *self,
                                 char const *__restrict key,
                                 dhash_t hash,
                                 DeeObject *def) {
	size_t i, perturb;
...
DeeRoDict_GetItemNRStringLenHashDef(DeeRoDictObject *self,
                                    char const *__restrict key,
                                    size_t keylen,
                                    dhash_t hash,
                                    DeeObject *def) {
...
DeeRoDict_HasItemStringHash(DeeRoDictObject *__restrict self,
                            char const *__restrict key,
                            dhash_t hash) {
	size_t i, perturb;
	struct rodict_item *item;
...
INTERN WUNUSED NONNULL((1, 2)) bool DCALL
DeeRoDict_HasItemStringLenHash(DeeRoDictObject *__restrict self,
                               char const *__restrict key,
                               size_t keylen,
                               dhash_t hash) {
	size_t i, perturb;
...
rodict_getitem_def(DeeObject *self, DeeObject *key, DeeObject *def) {
...
PRIVATE struct type_nsi tpconst rodict_nsi = {
	...
	/* .nsi_flags   = */ TYPE_SEQX_FNORMAL,
	{
		/* .nsi_maplike = */ {
			...
			/* .nsi_getdefault = */ (dfunptr_t)&rodict_getitem_def
		}
	}
};
...
rodict_get(RoDict *self, size_t argc, DeeObject *const *argv) {
	...
	if (DeeArg_Unpack(argc, argv, "o|o:get", &key, &def))
		goto err;
	return rodict_getitem_def((DeeObject *)self, key, def);
err:
	return NULL;
}
...
PRIVATE struct type_operator tpconst rodict_operators[] = {
	...
	//TODO:TYPE_OPERATOR_FLAGS(OPERATOR_0029_EQ, METHOD_FCONSTCALL | METHOD_FCONSTCALL_IF_SEQ_CONSTCOMPARE | METHOD_FNOREFESCAPE),
	//TODO:TYPE_OPERATOR_FLAGS(OPERATOR_002A_NE, METHOD_FCONSTCALL | METHOD_FCONSTCALL_IF_SEQ_CONSTCOMPARE | METHOD_FNOREFESCAPE),
	//TODO:TYPE_OPERATOR_FLAGS(OPERATOR_002B_LO, METHOD_FCONSTCALL | METHOD_FCONSTCALL_IF_SEQ_CONSTCOMPARE | METHOD_FNOREFESCAPE),
	//TODO:TYPE_OPERATOR_FLAGS(OPERATOR_002C_LE, METHOD_FCONSTCALL | METHOD_FCONSTCALL_IF_SEQ_CONSTCOMPARE | METHOD_FNOREFESCAPE),
	//TODO:TYPE_OPERATOR_FLAGS(OPERATOR_002D_GR, METHOD_FCONSTCALL | METHOD_FCONSTCALL_IF_SEQ_CONSTCOMPARE | METHOD_FNOREFESCAPE),
	//TODO:TYPE_OPERATOR_FLAGS(OPERATOR_002E_GE, METHOD_FCONSTCALL | METHOD_FCONSTCALL_IF_SEQ_CONSTCOMPARE | METHOD_FNOREFESCAPE),
	...
	TYPE_OPERATOR_FLAGS(OPERATOR_0031_CONTAINS, METHOD_FCONSTCALL | METHOD_FCONSTCALL_IF_MAP_CONSTCONTAINS | METHOD_FNOREFESCAPE),
	TYPE_OPERATOR_FLAGS(OPERATOR_0032_GETITEM, METHOD_FCONSTCALL | METHOD_FCONSTCALL_IF_MAP_CONSTCONTAINS | METHOD_FNOREFESCAPE),
};
