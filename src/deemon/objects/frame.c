...
#include <deemon/object.h>             /* ASSERT_OBJECT_OPT, ASSERT_OBJECT_TYPE_EXACT, DREF, DeeObject, DeeObject_AsUInt32, DeeObject_Type, DeeTypeObject, Dee_AsObject, Dee_BOUND_*, Dee_Decref*, Dee_Incref, Dee_XDecref, Dee_XIncref, Dee_formatprinter_t, Dee_ssize_t, ITER_DONE, ITER_ISOK, OBJECT_HEAD_INIT */
...
#include <deemon/type.h>               /* DeeObject_InitStatic, DeeType_Type, Dee_TYPE_CONSTRUCTOR_INIT_FIXED, Dee_XVisit, Dee_visit_t, METHOD_FCONSTCALL, METHOD_FNOREFESCAPE, STRUCT_CONST, STRUCT_OBJECT_AB, TF_NONE, TP_FFINAL, TP_FNORMAL, TYPE_*, type_getset, type_member */
...
(DCALL DeeFrame_NewReferenceWithLock)(/*[0..1]*/ DeeObject *owner,
	...
	Dee_XIncref(owner);
	DeeObject_InitStatic(result, &DeeFrame_Type);
done:
