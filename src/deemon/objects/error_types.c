...
PRIVATE struct type_member error_members[] = {
    ...
    TYPE_MEMBER_FIELD_DOC("message",STRUCT_CONST|STRUCT_OBJECT_OPT,offsetof(DeeErrorObject,e_message),
                          "->string\n"
...
PRIVATE struct type_member nomemory_members[] = {
    TYPE_MEMBER_FIELD("size",STRUCT_CONST|STRUCT_SIZE_T,offsetof(DeeNoMemoryErrorObject,nm_allocsize)),
    TYPE_MEMBER_END
};
PRIVATE int DCALL
