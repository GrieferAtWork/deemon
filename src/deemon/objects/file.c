...
PRIVATE struct type_method file_class_methods[] = {
    { "open", &file_class_open,
      DOC("(string path,string mode=\"r\")->file\n"
          ...
          "Mode is implemented as a comma-seperated list of open options that include "
          ...
          "In addition to this, any of the comma-seperated options can be one of the following "
