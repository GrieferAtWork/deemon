...
PUBLIC DeeTypeObject DeeObjMethod_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&objmethod_visit,
	/* .tp_gc            = */ NULL,
...
dockwdsiter_next(DocKwdsIterator *__restrict self) {
	...
	if (is_escaped) {
		...
		if (Dee_unicode_printer_print(&printer, flush_start, (size_t)(name_end - flush_start)) < 0)
			goto err_printer;
...
INTERN DeeTypeObject DocKwdsIterator_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&dockwdsiter_visit,
	/* .tp_gc            = */ NULL,
...
INTERN DeeTypeObject DocKwds_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&dockwds_visit,
	/* .tp_gc            = */ NULL,
...
PUBLIC DeeTypeObject DeeKwObjMethod_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&kwobjmethod_visit,
	/* .tp_gc            = */ NULL,
	/* .tp_math          = */ DEFIMPL_UNSUPPORTED(&default__tp_math__AE7A38D3B0C75E4B),
...
PUBLIC DeeTypeObject DeeClsMethod_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&clsmethod_visit,
	/* .tp_gc            = */ NULL,
	/* .tp_math          = */ DEFIMPL_UNSUPPORTED(&default__tp_math__AE7A38D3B0C75E4B),
...
PUBLIC DeeTypeObject DeeKwClsMethod_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&kwclsmethod_visit,
	/* .tp_gc            = */ NULL,
	/* .tp_math          = */ DEFIMPL_UNSUPPORTED(&default__tp_math__AE7A38D3B0C75E4B),
...
PUBLIC DeeTypeObject DeeClsProperty_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&clsproperty_visit,
	/* .tp_gc            = */ NULL,
	/* .tp_math          = */ DEFIMPL_UNSUPPORTED(&default__tp_math__AE7A38D3B0C75E4B),
...
PUBLIC DeeTypeObject DeeClsMember_Type = {
	...
	/* .tp_visit         = */ (void (DCALL *)(DeeObject *__restrict, Dee_visit_t, void *))&clsmember_visit,
	/* .tp_gc            = */ NULL,
	/* .tp_math          = */ DEFIMPL_UNSUPPORTED(&default__tp_math__AE7A38D3B0C75E4B),
...
PRIVATE WUNUSED NONNULL((1, 2)) struct Dee_module_symbol *DCALL
cmethod_getmodsym(DeeModuleObject *__restrict mod,
                  Dee_cmethod_t func_ptr) {
	uint16_t addr;
	struct Dee_module_symbol *result;
