 ...
 */
#ifndef GUARD_DEEMON_OBJECTS_RODICT_H
#define GUARD_DEEMON_OBJECTS_RODICT_H 1
...
typedef struct {
	PROXY_OBJECT_HEAD_EX(DeeRoDictObject, rodi_dict) /* [1..1][const] The RoDict being iterated. */
...
#endif /* !GUARD_DEEMON_OBJECTS_RODICT_H */
