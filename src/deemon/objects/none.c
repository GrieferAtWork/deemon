...
#include <hybrid/typecore.h> /* __SIZEOF_INT__, __SIZEOF_POINTER__, __SIZEOF_REGISTER__, __SIZEOF_SIZE_T__ */
...
/*[[[deemon (printSpecialTypeMhCacheBody from "..method-hints.method-hints")({"$none", "$empty"});]]]*/
	...
	/* .mh_set_delfirst                            = */ &default__set_delfirst__none,
	...
	/* .mh_set_dellast                             = */ &default__set_dellast__none,
