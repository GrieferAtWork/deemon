...
/*[[[deemon (printSpecialTypeMhCacheBody from "..method-hints.method-hints")({"$none", "$empty"});]]]*/
	...
	/* .mh_set_trygetfirst                         = */ &default__set_trygetfirst__none,
	/* .mh_set_getfirst                            = */ &default__set_getfirst__none,
	/* .mh_set_boundfirst                          = */ &default__set_boundfirst__none,
	/* .mh_set_delfirst                            = */ &default__set_delfirst__empty,
	/* .mh_set_setfirst                            = */ &default__set_setfirst__none,
	/* .mh_set_trygetlast                          = */ &default__set_trygetlast__none,
	/* .mh_set_getlast                             = */ &default__set_getlast__none,
	/* .mh_set_boundlast                           = */ &default__set_boundlast__none,
	/* .mh_set_dellast                             = */ &default__set_dellast__empty,
	/* .mh_set_setlast                             = */ &default__set_setlast__none,
