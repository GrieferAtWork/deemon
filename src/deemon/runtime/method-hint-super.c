...
#include <deemon/method-hints.h> /* DeeMH_map_enumerate_range_t, DeeMH_map_enumerate_t, DeeMH_map_frozen_t, DeeMH_map_iterkeys_t, DeeMH_map_itervalues_t, DeeMH_map_keys_t, DeeMH_map_makeenumeration_t, DeeMH_map_makeenumeration_with_range_t, DeeMH_map_operator_add_t, DeeMH_map_operator_and_t, DeeMH_map_operator_bounditem_index_t, DeeMH_map_operator_bounditem_string_hash_t, DeeMH_map_operator_bounditem_string_len_hash_t, DeeMH_map_operator_bounditem_t, DeeMH_map_operator_compare_eq_t, DeeMH_map_operator_contains_t, DeeMH_map_operator_delitem_index_t, DeeMH_map_operator_delitem_string_hash_t, DeeMH_map_operator_delitem_string_len_hash_t, DeeMH_map_operator_delitem_t, DeeMH_map_operator_eq_t, DeeMH_map_operator_foreach_pair_t, DeeMH_map_operator_ge_t, DeeMH_map_operator_getitem_index_t, DeeMH_map_operator_getitem_string_hash_t, DeeMH_map_operator_getitem_string_len_hash_t, DeeMH_map_operator_getitem_t, DeeMH_map_operator_gr_t, DeeMH_map_operator_hash_t, DeeMH_map_operator_hasitem_index_t, DeeMH_map_operator_hasitem_string_hash_t, DeeMH_map_operator_hasitem_string_len_hash_t, DeeMH_map_operator_hasitem_t, DeeMH_map_operator_inplace_add_t, DeeMH_map_operator_inplace_and_t, DeeMH_map_operator_inplace_sub_t, DeeMH_map_operator_inplace_xor_t, DeeMH_map_operator_iter_t, DeeMH_map_operator_le_t, DeeMH_map_operator_lo_t, DeeMH_map_operator_ne_t, DeeMH_map_operator_setitem_index_t, DeeMH_map_operator_setitem_string_hash_t, DeeMH_map_operator_setitem_string_len_hash_t, DeeMH_map_operator_setitem_t, DeeMH_map_operator_size_t, DeeMH_map_operator_sizeob_t, DeeMH_map_operator_sub_t, DeeMH_map_operator_trycompare_eq_t, DeeMH_map_operator_trygetitem_index_t, DeeMH_map_operator_trygetitem_string_hash_t, DeeMH_map_operator_trygetitem_string_len_hash_t, DeeMH_map_operator_trygetitem_t, DeeMH_map_operator_xor_t, DeeMH_map_pop_t, DeeMH_map_pop_with_default_t, DeeMH_map_popitem_t, DeeMH_map_remove_t, DeeMH_map_removekeys_t, DeeMH_map_setdefault_t, DeeMH_map_setnew_ex_t, DeeMH_map_setnew_t, DeeMH_map_setold_ex_t, DeeMH_map_setold_t, DeeMH_map_update_t, DeeMH_map_values_t, DeeMH_seq_all_t, DeeMH_seq_all_with_key_t, DeeMH_seq_all_with_range_and_key_t, DeeMH_seq_all_with_range_t, DeeMH_seq_any_t, DeeMH_seq_any_with_key_t, DeeMH_seq_any_with_range_and_key_t, DeeMH_seq_any_with_range_t, DeeMH_seq_append_t, DeeMH_seq_bfind_t, DeeMH_seq_bfind_with_key_t, DeeMH_seq_boundfirst_t, DeeMH_seq_boundlast_t, DeeMH_seq_bposition_t, DeeMH_seq_bposition_with_key_t, DeeMH_seq_brange_t, DeeMH_seq_brange_with_key_t, DeeMH_seq_cached_t, DeeMH_seq_clear_t, DeeMH_seq_contains_t, DeeMH_seq_contains_with_key_t, DeeMH_seq_contains_with_range_and_key_t, DeeMH_seq_contains_with_range_t, DeeMH_seq_count_t, DeeMH_seq_count_with_key_t, DeeMH_seq_count_with_range_and_key_t, DeeMH_seq_count_with_range_t, DeeMH_seq_delfirst_t, DeeMH_seq_dellast_t, DeeMH_seq_endswith_t, DeeMH_seq_endswith_with_key_t, DeeMH_seq_endswith_with_range_and_key_t, DeeMH_seq_endswith_with_range_t, DeeMH_seq_enumerate_index_t, DeeMH_seq_enumerate_t, DeeMH_seq_erase_t, DeeMH_seq_extend_t, DeeMH_seq_fill_t, DeeMH_seq_find_t, DeeMH_seq_find_with_key_t, DeeMH_seq_frozen_t, DeeMH_seq_getfirst_t, DeeMH_seq_getlast_t, DeeMH_seq_insert_t, DeeMH_seq_insertall_t, DeeMH_seq_locate_t, DeeMH_seq_locate_with_range_t, DeeMH_seq_makeenumeration_t, DeeMH_seq_makeenumeration_with_intrange_t, DeeMH_seq_makeenumeration_with_range_t, DeeMH_seq_max_t, DeeMH_seq_max_with_key_t, DeeMH_seq_max_with_range_and_key_t, DeeMH_seq_max_with_range_t, DeeMH_seq_min_t, DeeMH_seq_min_with_key_t, DeeMH_seq_min_with_range_and_key_t, DeeMH_seq_min_with_range_t, DeeMH_seq_operator_add_t, DeeMH_seq_operator_assign_t, DeeMH_seq_operator_bool_t, DeeMH_seq_operator_bounditem_index_t, DeeMH_seq_operator_bounditem_t, DeeMH_seq_operator_compare_eq_t, DeeMH_seq_operator_compare_t, DeeMH_seq_operator_contains_t, DeeMH_seq_operator_delitem_index_t, DeeMH_seq_operator_delitem_t, DeeMH_seq_operator_delrange_index_n_t, DeeMH_seq_operator_delrange_index_t, DeeMH_seq_operator_delrange_t, DeeMH_seq_operator_eq_t, DeeMH_seq_operator_foreach_pair_t, DeeMH_seq_operator_foreach_t, DeeMH_seq_operator_ge_t, DeeMH_seq_operator_getitem_index_t, DeeMH_seq_operator_getitem_t, DeeMH_seq_operator_getrange_index_n_t, DeeMH_seq_operator_getrange_index_t, DeeMH_seq_operator_getrange_t, DeeMH_seq_operator_gr_t, DeeMH_seq_operator_hash_t, DeeMH_seq_operator_hasitem_index_t, DeeMH_seq_operator_hasitem_t, DeeMH_seq_operator_inplace_add_t, DeeMH_seq_operator_inplace_mul_t, DeeMH_seq_operator_iter_t, DeeMH_seq_operator_le_t, DeeMH_seq_operator_lo_t, DeeMH_seq_operator_mul_t, DeeMH_seq_operator_ne_t, DeeMH_seq_operator_setitem_index_t, DeeMH_seq_operator_setitem_t, DeeMH_seq_operator_setrange_index_n_t, DeeMH_seq_operator_setrange_index_t, DeeMH_seq_operator_setrange_t, DeeMH_seq_operator_size_t, DeeMH_seq_operator_sizeob_t, DeeMH_seq_operator_trycompare_eq_t, DeeMH_seq_operator_trygetitem_index_t, DeeMH_seq_operator_trygetitem_t, DeeMH_seq_parity_t, DeeMH_seq_parity_with_key_t, DeeMH_seq_parity_with_range_and_key_t, DeeMH_seq_parity_with_range_t, DeeMH_seq_pop_t, DeeMH_seq_pushfront_t, DeeMH_seq_reduce_t, DeeMH_seq_reduce_with_init_t, DeeMH_seq_reduce_with_range_and_init_t, DeeMH_seq_reduce_with_range_t, DeeMH_seq_remove_t, DeeMH_seq_remove_with_key_t, DeeMH_seq_removeall_t, DeeMH_seq_removeall_with_key_t, DeeMH_seq_removeif_t, DeeMH_seq_resize_t, DeeMH_seq_reverse_t, DeeMH_seq_reversed_t, DeeMH_seq_rfind_t, DeeMH_seq_rfind_with_key_t, DeeMH_seq_rlocate_t, DeeMH_seq_rlocate_with_range_t, DeeMH_seq_rremove_t, DeeMH_seq_rremove_with_key_t, DeeMH_seq_setfirst_t, DeeMH_seq_setlast_t, DeeMH_seq_sort_t, DeeMH_seq_sort_with_key_t, DeeMH_seq_sorted_t, DeeMH_seq_sorted_with_key_t, DeeMH_seq_startswith_t, DeeMH_seq_startswith_with_key_t, DeeMH_seq_startswith_with_range_and_key_t, DeeMH_seq_startswith_with_range_t, DeeMH_seq_sum_t, DeeMH_seq_sum_with_range_t, DeeMH_seq_trygetfirst_t, DeeMH_seq_trygetlast_t, DeeMH_seq_unpack_ex_t, DeeMH_seq_unpack_t, DeeMH_seq_unpack_ub_t, DeeMH_seq_xchitem_index_t, DeeMH_set_boundfirst_t, DeeMH_set_boundlast_t, DeeMH_set_delfirst_t, DeeMH_set_dellast_t, DeeMH_set_frozen_t, DeeMH_set_getfirst_t, DeeMH_set_getlast_t, DeeMH_set_insert_t, DeeMH_set_insertall_t, DeeMH_set_operator_add_t, DeeMH_set_operator_and_t, DeeMH_set_operator_bool_t, DeeMH_set_operator_compare_eq_t, DeeMH_set_operator_eq_t, DeeMH_set_operator_foreach_t, DeeMH_set_operator_ge_t, DeeMH_set_operator_gr_t, DeeMH_set_operator_hash_t, DeeMH_set_operator_inplace_add_t, DeeMH_set_operator_inplace_and_t, DeeMH_set_operator_inplace_sub_t, DeeMH_set_operator_inplace_xor_t, DeeMH_set_operator_inv_t, DeeMH_set_operator_iter_t, DeeMH_set_operator_le_t, DeeMH_set_operator_lo_t, DeeMH_set_operator_ne_t, DeeMH_set_operator_size_t, DeeMH_set_operator_sizeob_t, DeeMH_set_operator_sub_t, DeeMH_set_operator_trycompare_eq_t, DeeMH_set_operator_xor_t, DeeMH_set_pop_t, DeeMH_set_pop_with_default_t, DeeMH_set_remove_t, DeeMH_set_removeall_t, DeeMH_set_setfirst_t, DeeMH_set_setlast_t, DeeMH_set_trygetfirst_t, DeeMH_set_trygetlast_t, DeeMH_set_unify_t, DeeType_GetMethodHintForSuper, Dee_seq_enumerate_index_t, Dee_seq_enumerate_t, Dee_super_method_hint */
#include <deemon/object.h>       /* DREF, DeeObject, DeeTypeObject, Dee_AsObject, Dee_Decref*, Dee_Incref, Dee_foreach_pair_t, Dee_foreach_t, Dee_hash_t, Dee_ssize_t */
#include <deemon/super.h>        /* DeeSuperObject, DeeSuper_New */
