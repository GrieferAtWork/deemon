...
/* Ensure that the Dee_BOUND_* constants (when used in the context of Dee_HAS_*)
 * are interpreted such that they describe the semantic existence of the item or
 * attribute being described by the bound-constant.
 *
 * This is an ABI-requirement that allows code to re-use "tp_bounditem" in order
 * to implement "tp_hasitem" operators by simply assigning the "tp_bounditem"
 * operator to "tp_hasitem". */
STATIC_ASSERT_HAS_ISERR(Dee_BOUND_ERR);
STATIC_ASSERT_HAS_ISNO_(Dee_BOUND_MISSING);
STATIC_ASSERT_HAS_ISYES(Dee_BOUND_YES);
STATIC_ASSERT_HAS_ISYES(Dee_BOUND_NO);

/* Assert that Dee_HAS_* and Dee_BOUND_* work */
STATIC_ASSERT_HAS_ISERR(-77); /* All negative values must be treated as error */
STATIC_ASSERT_HAS_ISERR(Dee_HAS_ERR);
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_NO);
STATIC_ASSERT_HAS_ISYES(Dee_HAS_YES);
STATIC_ASSERT_HAS_ISYES(77); /* All positive values must be treated as "true" */

STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_LO_NO_ERR(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_LO_NO_ERR(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_LO_NO_ERR(Dee_COMPARE_GR));
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_COMPARE_LO(Dee_COMPARE_ERR));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_LO(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_LO(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_LO(Dee_COMPARE_GR));

STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_LE_NO_ERR(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_LE_NO_ERR(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_LE_NO_ERR(Dee_COMPARE_GR));
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_COMPARE_LE(Dee_COMPARE_ERR));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_LE(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_LE(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_LE(Dee_COMPARE_GR));

STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_EQ_NO_ERR(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_EQ_NO_ERR(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_EQ_NO_ERR(Dee_COMPARE_NE));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_EQ_NO_ERR(Dee_COMPARE_GR));
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_COMPARE_EQ(Dee_COMPARE_ERR));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_EQ(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_EQ(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_EQ(Dee_COMPARE_NE));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_EQ(Dee_COMPARE_GR));

STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_NE_NO_ERR(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_NE_NO_ERR(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_NE_NO_ERR(Dee_COMPARE_NE));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_NE_NO_ERR(Dee_COMPARE_GR));
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_COMPARE_NE(Dee_COMPARE_ERR));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_NE(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_NE(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_NE(Dee_COMPARE_NE));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_NE(Dee_COMPARE_GR));

STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_GR_NO_ERR(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_GR_NO_ERR(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_GR_NO_ERR(Dee_COMPARE_GR));
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_COMPARE_GR(Dee_COMPARE_ERR));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_GR(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_GR(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_GR(Dee_COMPARE_GR));

STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_GE_NO_ERR(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_GE_NO_ERR(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_GE_NO_ERR(Dee_COMPARE_GR));
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_COMPARE_GE(Dee_COMPARE_ERR));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_COMPARE_GE(Dee_COMPARE_LO));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_GE(Dee_COMPARE_EQ));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_COMPARE_GE(Dee_COMPARE_GR));

STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROMBOOL(0));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROMBOOL(1));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROMBOOL(77));

STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROMBOUND_NO_ERR(Dee_BOUND_MISSING));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROMBOUND_NO_ERR(Dee_BOUND_YES));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROMBOUND_NO_ERR(Dee_BOUND_NO));
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROMBOUND(Dee_BOUND_ERR));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROMBOUND(Dee_BOUND_MISSING));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROMBOUND(Dee_BOUND_YES));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROMBOUND(Dee_BOUND_NO));

STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROMPRESENT_NO_ERR(Dee_BOUND_MISSING));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROMPRESENT_NO_ERR(Dee_BOUND_YES));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROMPRESENT_NO_ERR(Dee_BOUND_NO));
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROMPRESENT(Dee_BOUND_ERR));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROMPRESENT(Dee_BOUND_MISSING));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROMPRESENT(Dee_BOUND_YES));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROMPRESENT(Dee_BOUND_NO));

STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROMITERNOK((DeeObject *)NULL));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROMITERNOK((DeeObject *)ITER_DONE));

STATIC_ASSERT(Dee_BOUND_FROMITERNOK((DeeObject *)NULL) == Dee_BOUND_ERR);
STATIC_ASSERT(Dee_BOUND_FROMITERNOK((DeeObject *)ITER_DONE) == Dee_BOUND_NO);
...
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_eM1_n0_yM2(-1));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_eM1_n0_yM2(-2));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_eM1_n0_yM2(0));
...
STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_eM1_n0_y1(-1));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_eM1_n0_y1(0));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_eM1_n0_y1(1));

STATIC_ASSERT(Dee_HAS_INTO_eM1_n0_y1(-77) == -1);
STATIC_ASSERT(Dee_HAS_INTO_eM1_n0_y1(Dee_HAS_ERR) == -1);
STATIC_ASSERT(Dee_HAS_INTO_eM1_n0_y1(Dee_HAS_NO) == 0);
STATIC_ASSERT(Dee_HAS_INTO_eM1_n0_y1(Dee_HAS_YES) == 1);
STATIC_ASSERT(Dee_HAS_INTO_eM1_n0_y1(77) == 1);

STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_eM1_n1_y0(-1));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_eM1_n1_y0(1));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_eM1_n1_y0(0));

STATIC_ASSERT(Dee_HAS_INTO_eM1_n1_y0(-77) == -1);
STATIC_ASSERT(Dee_HAS_INTO_eM1_n1_y0(Dee_HAS_ERR) == -1);
STATIC_ASSERT(Dee_HAS_INTO_eM1_n1_y0(Dee_HAS_NO) == 1);
STATIC_ASSERT(Dee_HAS_INTO_eM1_n1_y0(Dee_HAS_YES) == 0);
STATIC_ASSERT(Dee_HAS_INTO_eM1_n1_y0(77) == 0);

STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_eM1_n0_yM2_yM3(-1));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_eM1_n0_yM2_yM3(-2));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_eM1_n0_yM2_yM3(-3));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_eM1_n0_yM2_yM3(0));

STATIC_ASSERT_HAS_ISERR(Dee_HAS_FROM_eM1_n0_nM4_yM2_yM3(-1));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_eM1_n0_nM4_yM2_yM3(-2));
STATIC_ASSERT_HAS_ISYES(Dee_HAS_FROM_eM1_n0_nM4_yM2_yM3(-3));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_eM1_n0_nM4_yM2_yM3(0));
STATIC_ASSERT_HAS_ISNO_(Dee_HAS_FROM_eM1_n0_nM4_yM2_yM3(-4));

STATIC_ASSERT(Dee_BOUND_FROM_eM1_m0_yM2_nM3(-1) == Dee_BOUND_ERR);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_m0_yM2_nM3(0) == Dee_BOUND_MISSING);
...
STATIC_ASSERT(Dee_BOUND_FROM_eM1_m0_mM4_yM2_nM3(-2) == Dee_BOUND_YES);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_m0_mM4_yM2_nM3(-3) == Dee_BOUND_NO);

STATIC_ASSERT(Dee_BOUND_INTO_eM1_m1_y0_nM2(Dee_BOUND_ERR) == -1);
STATIC_ASSERT(Dee_BOUND_INTO_eM1_m1_y0_nM2(Dee_BOUND_MISSING) == 1);
STATIC_ASSERT(Dee_BOUND_INTO_eM1_m1_y0_nM2(Dee_BOUND_YES) == 0);
STATIC_ASSERT(Dee_BOUND_INTO_eM1_m1_y0_nM2(Dee_BOUND_NO) == -2);

STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_y0_nM2(-1) == Dee_BOUND_ERR);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_y0_nM2(1) == Dee_BOUND_MISSING);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_y0_nM2(2) == Dee_BOUND_MISSING);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_y0_nM2(77) == Dee_BOUND_MISSING);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_y0_nM2(0) == Dee_BOUND_YES);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_y0_nM2(-2) == Dee_BOUND_NO);

STATIC_ASSERT(Dee_BOUND_INTO_eM1_m1_yM2_n0(Dee_BOUND_ERR) == -1);
STATIC_ASSERT(Dee_BOUND_INTO_eM1_m1_yM2_n0(Dee_BOUND_MISSING) == 1);
STATIC_ASSERT(Dee_BOUND_INTO_eM1_m1_yM2_n0(Dee_BOUND_YES) == -2);
STATIC_ASSERT(Dee_BOUND_INTO_eM1_m1_yM2_n0(Dee_BOUND_NO) == 0);

STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_yM2_n0(-1) == Dee_BOUND_ERR);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_yM2_n0(1) == Dee_BOUND_MISSING);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_yM2_n0(2) == Dee_BOUND_MISSING);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_yM2_n0(77) == Dee_BOUND_MISSING);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_yM2_n0(0) == Dee_BOUND_NO);
STATIC_ASSERT(Dee_BOUND_FROM_eM1_mP_yM2_n0(-2) == Dee_BOUND_YES);

STATIC_ASSERT(Dee_COMPARE_EQ_FROMHAS(-77) == Dee_COMPARE_ERR);
STATIC_ASSERT(Dee_COMPARE_EQ_FROMHAS(Dee_HAS_ERR) == Dee_COMPARE_ERR);
STATIC_ASSERT(Dee_COMPARE_EQ_FROMHAS(Dee_HAS_NO) == Dee_COMPARE_LO ||
              Dee_COMPARE_EQ_FROMHAS(Dee_HAS_NO) == Dee_COMPARE_GR);
STATIC_ASSERT(Dee_COMPARE_EQ_FROMHAS(Dee_HAS_YES) == Dee_COMPARE_EQ);
STATIC_ASSERT(Dee_COMPARE_EQ_FROMHAS(77) == Dee_COMPARE_EQ);

STATIC_ASSERT(Dee_COMPARE_NE_FROMHAS(-77) == Dee_COMPARE_ERR);
STATIC_ASSERT(Dee_COMPARE_NE_FROMHAS(Dee_HAS_ERR) == Dee_COMPARE_ERR);
STATIC_ASSERT(Dee_COMPARE_NE_FROMHAS(Dee_HAS_NO) == Dee_COMPARE_EQ);
STATIC_ASSERT(Dee_COMPARE_NE_FROMHAS(Dee_HAS_YES) == Dee_COMPARE_LO ||
              Dee_COMPARE_NE_FROMHAS(Dee_HAS_YES) == Dee_COMPARE_GR);
STATIC_ASSERT(Dee_COMPARE_NE_FROMHAS(77) == Dee_COMPARE_LO ||
              Dee_COMPARE_NE_FROMHAS(77) == Dee_COMPARE_GR);

STATIC_ASSERT(Dee_BOUND_FROMHAS_BOUND(-77) == Dee_BOUND_ERR);
STATIC_ASSERT(Dee_BOUND_FROMHAS_BOUND(Dee_HAS_ERR) == Dee_BOUND_ERR);
STATIC_ASSERT(Dee_BOUND_FROMHAS_BOUND(Dee_HAS_NO) == Dee_BOUND_MISSING);
STATIC_ASSERT(Dee_BOUND_FROMHAS_BOUND(Dee_HAS_YES) == Dee_BOUND_YES);
STATIC_ASSERT(Dee_BOUND_FROMHAS_BOUND(77) == Dee_BOUND_YES);

STATIC_ASSERT(Dee_BOUND_FROMHAS_UNBOUND(-77) == Dee_BOUND_ERR);
STATIC_ASSERT(Dee_BOUND_FROMHAS_UNBOUND(Dee_HAS_ERR) == Dee_BOUND_ERR);
STATIC_ASSERT(Dee_BOUND_FROMHAS_UNBOUND(Dee_HAS_NO) == Dee_BOUND_MISSING);
STATIC_ASSERT(Dee_BOUND_FROMHAS_UNBOUND(Dee_HAS_YES) == Dee_BOUND_NO);
STATIC_ASSERT(Dee_BOUND_FROMHAS_UNBOUND(77) == Dee_BOUND_NO);

STATIC_ASSERT(Dee_COMPARE_INTO_eM1_eqM2_ne0(Dee_COMPARE_ERR) == -1);
STATIC_ASSERT(Dee_COMPARE_INTO_eM1_eqM2_ne0(Dee_COMPARE_EQ) == -2);
STATIC_ASSERT(Dee_COMPARE_INTO_eM1_eqM2_ne0(Dee_COMPARE_LO) == 0);
STATIC_ASSERT(Dee_COMPARE_INTO_eM1_eqM2_ne0(Dee_COMPARE_GR) == 0);

STATIC_ASSERT(Dee_COMPARE_INTO_eM1_eq1_neM2(Dee_COMPARE_ERR) == -1);
STATIC_ASSERT(Dee_COMPARE_INTO_eM1_eq1_neM2(Dee_COMPARE_EQ) == 1);
