...
#include <deemon/method-hints.h> /* DeeMH_*_t, Dee_type_mh_cache_array, Dee_type_trait_t */
#include <deemon/object.h>       /* DeeTypeObject, Dee_funptr_t */
#include <deemon/type.h>         /* Dee_type_member */
