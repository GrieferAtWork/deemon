...
#define MHC_FIRST mhc___seq_bool__
	...
	union mhc_slot mhc_get___seq_cached__;
	union mhc_slot mhc_get___seq_frozen__;
	union mhc_slot mhc___seq_any__;
	union mhc_slot mhc___seq_all__;
	union mhc_slot mhc___seq_parity__;
	union mhc_slot mhc___seq_reduce__;
	...
	union mhc_slot mhc___seq_remove__;
	union mhc_slot mhc___seq_rremove__;
	union mhc_slot mhc___seq_removeall__;
	union mhc_slot mhc___seq_removeif__;
	union mhc_slot mhc___seq_resize__;
	union mhc_slot mhc___seq_fill__;
	union mhc_slot mhc___seq_reverse__;
	union mhc_slot mhc___seq_reversed__;
	union mhc_slot mhc___seq_sort__;
	union mhc_slot mhc___seq_sorted__;
	union mhc_slot mhc___seq_bfind__;
	union mhc_slot mhc___seq_bposition__;
	union mhc_slot mhc___seq_brange__;
	...
	union mhc_slot mhc___set_lo__;
	union mhc_slot mhc___set_le__;
	union mhc_slot mhc___set_gr__;
	union mhc_slot mhc___set_ge__;
	union mhc_slot mhc___set_inv__;
	union mhc_slot mhc___set_add__;
	union mhc_slot mhc___set_sub__;
	union mhc_slot mhc___set_and__;
	union mhc_slot mhc___set_xor__;
	union mhc_slot mhc___set_inplace_add__;
	union mhc_slot mhc___set_inplace_sub__;
	...
	union mhc_slot mhc___set_removeall__;
	union mhc_slot mhc___set_pop__;
	...
	union mhc_slot mhc_get___map_keys__;
	union mhc_slot mhc_get___map_iterkeys__;
	union mhc_slot mhc_get___map_values__;
	union mhc_slot mhc_get___map_itervalues__;
	union mhc_slot mhc___map_enumerate__;
	union mhc_slot mhc___map_compare_eq__;
	union mhc_slot mhc___map_eq__;
	union mhc_slot mhc___map_ne__;
	union mhc_slot mhc___map_lo__;
	union mhc_slot mhc___map_le__;
	union mhc_slot mhc___map_gr__;
	union mhc_slot mhc___map_ge__;
	union mhc_slot mhc___map_add__;
	union mhc_slot mhc___map_sub__;
	union mhc_slot mhc___map_and__;
	union mhc_slot mhc___map_xor__;
	union mhc_slot mhc___map_inplace_add__;
	union mhc_slot mhc___map_inplace_sub__;
	union mhc_slot mhc___map_inplace_and__;
	union mhc_slot mhc___map_inplace_xor__;
	union mhc_slot mhc_get___map_frozen__;
	union mhc_slot mhc___map_setold__;
	union mhc_slot mhc___map_setold_ex__;
	union mhc_slot mhc___map_setnew__;
	union mhc_slot mhc___map_setnew_ex__;
	union mhc_slot mhc___map_setdefault__;
	union mhc_slot mhc___map_update__;
	union mhc_slot mhc___map_remove__;
	union mhc_slot mhc___map_removekeys__;
	union mhc_slot mhc___map_pop__;
	union mhc_slot mhc___map_popitem__;
