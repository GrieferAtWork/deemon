...
#define Dee_HashStr____set_bool__ _Dee_HashSelectC(0x7efbc859, 0x319c511db5ecf5b2)
DEF_STRING(str___set_bool__, "__set_bool__", 0x7efbc859, 0x319c511db5ecf5b2)
#define STR___set_bool__ DeeString_STR(&str___set_bool__)
...
#define Dee_HashStr____set_first__ _Dee_HashSelectC(0xfdfdb51d, 0xe79afa8c76f27c98)
DEF_STRING(str___set_first__, "__set_first__", 0xfdfdb51d, 0xe79afa8c76f27c98)
#define STR___set_first__ DeeString_STR(&str___set_first__)
#define Dee_HashStr____set_last__ _Dee_HashSelectC(0x3f122843, 0x943d984dd723e3f6)
DEF_STRING(str___set_last__, "__set_last__", 0x3f122843, 0x943d984dd723e3f6)
#define STR___set_last__ DeeString_STR(&str___set_last__)
...
#define Dee_HashStr__nextkey _Dee_HashSelectC(0xe9282b29, 0x5af27c2b877b49cf)
DEF_STRING(str_nextkey, "nextkey", 0xe9282b29, 0x5af27c2b877b49cf)
#define STR_nextkey DeeString_STR(&str_nextkey)
#define Dee_HashStr____iter_nextkey__ _Dee_HashSelectC(0xc52ffa38, 0x6d08b72ac548d67f)
DEF_STRING(str___iter_nextkey__, "__iter_nextkey__", 0xc52ffa38, 0x6d08b72ac548d67f)
#define STR___iter_nextkey__ DeeString_STR(&str___iter_nextkey__)
#define Dee_HashStr__nextvalue _Dee_HashSelectC(0x48509118, 0xcb131b8280e955b4)
DEF_STRING(str_nextvalue, "nextvalue", 0x48509118, 0xcb131b8280e955b4)
#define STR_nextvalue DeeString_STR(&str_nextvalue)
#define Dee_HashStr____iter_nextvalue__ _Dee_HashSelectC(0xb8f2cf12, 0x1ba1d9f97095217)
DEF_STRING(str___iter_nextvalue__, "__iter_nextvalue__", 0xb8f2cf12, 0x1ba1d9f97095217)
#define STR___iter_nextvalue__ DeeString_STR(&str___iter_nextvalue__)
#define Dee_HashStr____iter_advance__ _Dee_HashSelectC(0x6ed973a0, 0x5ade447fad9f1360)
DEF_STRING(str___iter_advance__, "__iter_advance__", 0x6ed973a0, 0x5ade447fad9f1360)
#define STR___iter_advance__ DeeString_STR(&str___iter_advance__)
#define Dee_HashStr____iter_prev__ _Dee_HashSelectC(0x5303641, 0xc63593d9e80d6923)
DEF_STRING(str___iter_prev__, "__iter_prev__", 0x5303641, 0xc63593d9e80d6923)
#define STR___iter_prev__ DeeString_STR(&str___iter_prev__)
#define Dee_HashStr____iter_revert__ _Dee_HashSelectC(0x322ba931, 0x91fa1f61fe6463d5)
DEF_STRING(str___iter_revert__, "__iter_revert__", 0x322ba931, 0x91fa1f61fe6463d5)
#define STR___iter_revert__ DeeString_STR(&str___iter_revert__)
#define Dee_HashStr____iter_bool__ _Dee_HashSelectC(0x1f130c86, 0xb770be13ea2dcdbc)
DEF_STRING(str___iter_bool__, "__iter_bool__", 0x1f130c86, 0xb770be13ea2dcdbc)
#define STR___iter_bool__ DeeString_STR(&str___iter_bool__)
#define Dee_HashStr____iter_index__ _Dee_HashSelectC(0x9a2af4b7, 0xcdcd97bb3fd0af60)
DEF_STRING(str___iter_index__, "__iter_index__", 0x9a2af4b7, 0xcdcd97bb3fd0af60)
#define STR___iter_index__ DeeString_STR(&str___iter_index__)
#define Dee_HashStr____iter_rewind__ _Dee_HashSelectC(0xec7f7301, 0xc9afcd981e8b1921)
DEF_STRING(str___iter_rewind__, "__iter_rewind__", 0xec7f7301, 0xc9afcd981e8b1921)
#define STR___iter_rewind__ DeeString_STR(&str___iter_rewind__)
#define Dee_HashStr____iter_peek__ _Dee_HashSelectC(0x787817d8, 0xa72422dc5cd23509)
DEF_STRING(str___iter_peek__, "__iter_peek__", 0x787817d8, 0xa72422dc5cd23509)
#define STR___iter_peek__ DeeString_STR(&str___iter_peek__)
