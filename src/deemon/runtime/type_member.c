...
#include <deemon/object.h>          /* ASSERT_OBJECT, DREF, DeeObject, DeeObject_*, DeeTypeObject, Dee_AsObject, Dee_Decref, Dee_HAS_*, Dee_Incref, Dee_TYPE, Dee_int128_t, Dee_uint128_t, ITER_DONE, return_reference_ */
