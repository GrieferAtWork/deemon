...
INTDEF WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL super_mh__seq_min(DeeSuperObject *self, DeeObject *def);
INTDEF WUNUSED NONNULL((1, 2, 3)) DREF DeeObject *DCALL super_mh__seq_min_with_key(DeeSuperObject *self, DeeObject *def, DeeObject *key);
INTDEF WUNUSED NONNULL((1, 4)) DREF DeeObject *DCALL super_mh__seq_min_with_range(DeeSuperObject *self, size_t start, size_t end, DeeObject *def);
INTDEF WUNUSED NONNULL((1, 4, 5)) DREF DeeObject *DCALL super_mh__seq_min_with_range_and_key(DeeSuperObject *self, size_t start, size_t end, DeeObject *def, DeeObject *key);
INTDEF WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL super_mh__seq_max(DeeSuperObject *self, DeeObject *def);
INTDEF WUNUSED NONNULL((1, 2, 3)) DREF DeeObject *DCALL super_mh__seq_max_with_key(DeeSuperObject *self, DeeObject *def, DeeObject *key);
INTDEF WUNUSED NONNULL((1, 4)) DREF DeeObject *DCALL super_mh__seq_max_with_range(DeeSuperObject *self, size_t start, size_t end, DeeObject *def);
INTDEF WUNUSED NONNULL((1, 4, 5)) DREF DeeObject *DCALL super_mh__seq_max_with_range_and_key(DeeSuperObject *self, size_t start, size_t end, DeeObject *def, DeeObject *key);
INTDEF WUNUSED NONNULL((1, 2)) DREF DeeObject *DCALL super_mh__seq_sum(DeeSuperObject *self, DeeObject *def);
INTDEF WUNUSED NONNULL((1, 2, 3)) DREF DeeObject *DCALL super_mh__seq_sum_with_key(DeeSuperObject *self, DeeObject *def, DeeObject *key);
INTDEF WUNUSED NONNULL((1, 4)) DREF DeeObject *DCALL super_mh__seq_sum_with_range(DeeSuperObject *self, size_t start, size_t end, DeeObject *def);
INTDEF WUNUSED NONNULL((1, 4, 5)) DREF DeeObject *DCALL super_mh__seq_sum_with_range_and_key(DeeSuperObject *self, size_t start, size_t end, DeeObject *def, DeeObject *key);
