...
#include <deemon/type.h>               /* DeeObject_Init, DeeObject_IsShared, DeeType_Type, Dee_TYPE_CONSTRUCTOR_INIT_VAR, Dee_Visit, Dee_Visitv, Dee_XVisit, METHOD_F*, OPERATOR_*, STRUCT_OBJECT, TF_*, TP_F*, TYPE_MEMBER*, TYPE_OPERATOR_FLAGS, type_* */
