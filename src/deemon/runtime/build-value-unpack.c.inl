...
#include <deemon/object.h>          /* DREF, DeeObject, DeeObject_*, Dee_Decref, Dee_HAS_ISERR, Dee_HAS_ISYES_NO_ERR, Dee_hash_t, Dee_int128_t, Dee_uint128_t, ITER_DONE */
...
err_iter:
	...
	case 'b': {
		...
		if (Dee_HAS_ISERR(temp))
			return temp;
		LOCAL_OUTPUT(bool, __ALIGNOF_BOOL__, !!Dee_HAS_ISYES_NO_ERR(temp));
	}	break;
