...
#include <deemon/compiler/lexer.h>  /* ast_parse_lookup_mode, ast_parse_unary, maybe_expression_begin */
#include <deemon/compiler/symbol.h> /* LOOKUP_SYM_ALLOWDECL, current_scope, del_local_symbol */
