 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_ASSUMES_C
#define GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_ASSUMES_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_ASSUMES_C */
