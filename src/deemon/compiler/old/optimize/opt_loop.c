...
#include <deemon/compiler/old/ast.h>      /* AST_FLOOP_FOREACH, AST_FLOOP_POSTCOND, ast, ast_decref */
#include <deemon/compiler/old/optimize.h> /* OPTIMIZE_FASSUME, OPTIMIZE_VERBOSE, ast_*, optimizer_* */
