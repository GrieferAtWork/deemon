 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_OPT_CONDITIONAL_C
#define GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_OPT_CONDITIONAL_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_OPT_CONDITIONAL_C */
