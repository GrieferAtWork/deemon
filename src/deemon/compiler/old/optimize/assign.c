 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_ASSIGN_C
#define GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_ASSIGN_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_ASSIGN_C */
