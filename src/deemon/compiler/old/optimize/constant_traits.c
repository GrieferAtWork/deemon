 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_CONSTANT_TRAITS_C
#define GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_CONSTANT_TRAITS_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_OPTIMIZE_CONSTANT_TRAITS_C */
