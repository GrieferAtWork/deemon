 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_ASM_SCOPE_C
#define GUARD_DEEMON_COMPILER_OLD_ASM_SCOPE_C 1

#include <deemon/api.h>

#include <deemon/compiler/old/assembler.h> /* ASM_*, asm_*, ast_genasm, ast_genasm_set, current_assembler */
#include <deemon/compiler/old/ast.h>       /* ast */
#include <deemon/compiler/old/symbol.h>    /* DeeScopeObject, SYMBOL_*, current_basescope, symbol */
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_ASM_SCOPE_C */
