 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_ASM_GENINPLACE_C
#define GUARD_DEEMON_COMPILER_OLD_ASM_GENINPLACE_C 1

#include <deemon/api.h>

#include <deemon/asm.h>                    /* instruction_t */
#include <deemon/compiler/old/assembler.h> /* ASM_G_FPUSHRES, asm_*, ast_genasm, ast_genasm_one, current_assembler */
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_ASM_GENINPLACE_C */
