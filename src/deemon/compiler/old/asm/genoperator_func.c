 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_ASM_GENOPERATOR_FUNC_C
#define GUARD_DEEMON_COMPILER_OLD_ASM_GENOPERATOR_FUNC_C 1

#include <deemon/api.h>

#include <deemon/compiler/old/assembler.h> /* ASM_G_FPUSHRES, asm_g*, asm_newmodule, ast_genasm_one */
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_ASM_GENOPERATOR_FUNC_C */
