 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_INTERFACE_IPARSER_C
#define GUARD_DEEMON_COMPILER_OLD_INTERFACE_IPARSER_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_INTERFACE_IPARSER_C */
