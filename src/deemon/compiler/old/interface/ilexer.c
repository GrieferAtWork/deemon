 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_INTERFACE_ILEXER_C
#define GUARD_DEEMON_COMPILER_OLD_INTERFACE_ILEXER_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_INTERFACE_ILEXER_C */
