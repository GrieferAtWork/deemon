 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_INTERFACE_ICOMPILER_C
#define GUARD_DEEMON_COMPILER_OLD_INTERFACE_ICOMPILER_C 1
...
#include <deemon/compiler/old/interface.h> /* DeeCompiler*, err_compiler_item_deleted, err_different_base_scope, err_different_root_scope, err_invalid_ast_basescope, err_invalid_ast_compiler, err_invalid_scope_compiler, err_invalid_symbol_compiler, err_symbol_not_reachable, scope_reaches_symbol, set_astloc_from_obj */
...
INTERN_TPCONST struct type_method tpconst compiler_methods[] = {
	...
	TYPE_KWMETHOD("maketry", &ast_maketry,
	              ...
	              /**/ "of tuples in the form of ($flags: ?Dstring, $mask: ?#Ast, $code: ?#Ast), where "
	              /**/ "$mask may also be passed as ?N in order to indicate the lack of a catch-mask\n"
	...
	TYPE_KWMETHOD("makeconditional", &ast_makeconditional,
	              ...
	              "but must be noted specifically, as the conditional branch is only evaluated once, meaning "
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_INTERFACE_ICOMPILER_C */
