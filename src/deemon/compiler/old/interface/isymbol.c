 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_INTERFACE_ISYMBOL_C
#define GUARD_DEEMON_COMPILER_OLD_INTERFACE_ISYMBOL_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_INTERFACE_ISYMBOL_C */
