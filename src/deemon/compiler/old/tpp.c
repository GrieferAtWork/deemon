 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_TPP_C
#define GUARD_DEEMON_COMPILER_OLD_TPP_C 1
...
#define TPP_USERDEFS                  <deemon/compiler/old/lexer.def>
#define TPP_USERSTREAM_FCLOSE(stream) Dee_Decref(stream)

/* Includes for TPP */
/* clang-format off */
#include <deemon/class.h>
#include <deemon/compiler/old/error.h>
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_TPP_C */
