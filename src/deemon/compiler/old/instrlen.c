 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_INSTRLEN_C
#define GUARD_DEEMON_COMPILER_OLD_INSTRLEN_C 1
...
#include <deemon/compiler/old/assembler.h> /* ASM_USING_READ */
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_INSTRLEN_C */
