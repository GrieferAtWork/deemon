 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_LEXER_STATEMENT_C
#define GUARD_DEEMON_COMPILER_OLD_LEXER_STATEMENT_C 1
...
#include <deemon/compiler/old/lexer.h>  /* AST_COMMA_*, ast_parse_*, ast_tags_clear, current_tags, parse_tags, parse_tags_block */
#include <deemon/compiler/old/symbol.h> /* BASESCOPE_FRETURN, BASESCOPE_FSWITCH, LOOKUP_SYM_ALLOWDECL, LOOKUP_SYM_NORMAL, ast_loc, current_basescope, lookup_label, new_case_label, new_default_label, scope_pop, scope_push, text_label */
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_LEXER_STATEMENT_C */
