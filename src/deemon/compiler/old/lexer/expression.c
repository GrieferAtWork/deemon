 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_LEXER_EXPRESSION_C
#define GUARD_DEEMON_COMPILER_OLD_LEXER_EXPRESSION_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_LEXER_EXPRESSION_C */
