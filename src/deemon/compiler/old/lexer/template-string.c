 ...
 */
#ifndef GUARD_DEEMON_COMPILER_OLD_LEXER_TEMPLATE_STRING_C
#define GUARD_DEEMON_COMPILER_OLD_LEXER_TEMPLATE_STRING_C 1
...
#endif /* !GUARD_DEEMON_COMPILER_OLD_LEXER_TEMPLATE_STRING_C */
