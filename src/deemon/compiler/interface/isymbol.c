...
PRIVATE struct type_method symbol_methods[] = {
	{ "getalias", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&symbol_getalias,
	  DOC("->?.\n"
	      "Either re-returns @this symbol, or unwinds it to return "
	      "the effective symbol that is being aliased by it") },
	{ "setalias", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&symbol_setalias,
	  DOC("(other:?.)->?.\n"
	...
	{ "setnone", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&symbol_setnone,
	  DOC("->?.\n"
	      "@throw TypeError Attempted to modify the typing of an $\"arg\" symbol\n"
