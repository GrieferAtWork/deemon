...
/* Use these names below so operators can be sorted based on lexicographical line sorting. */
...
vbool_field_nonzero(struct Dee_function_generator *__restrict self,
	...
	DO(Dee_function_generator_vdirect1(self));             /* value, reg:value->xx_field */
	DO(Dee_function_generator_vpop_at(self, 2));           /* reg:value->xx_field */
...
vsize_field_uint(struct Dee_function_generator *__restrict self,
	...
	DO(Dee_function_generator_vdirect1(self));                   /* value, reg:value->xx_size */
	DO(Dee_function_generator_vpop_at(self, 2));                 /* reg:value->xx_size */
...
cca_Mapping_setdefault(struct Dee_function_generator *__restrict self, Dee_vstackaddr_t argc) {
	...
	Dee_function_generator_vtop_direct_setref(self);                          /* this, key, value, ref:value */
	...
	return Dee_function_generator_vpopmany(self, 3);        /* ref:current_value */
err_common_state:
	Dee_memstate_decref(common_state);
err:
	return -1;
