...
""", docStringPrefix: "ivd", defineKwList: true);]]]*/
	static DEFINE_KWLIST(Decoder_kwlist, { KEX("codec", 0x91dfc790, 0x678d4474a4f58564), KEX("out", 0x20bcdfe4, 0xfc801ac012e9f722), KEX("errors", 0xd327c5ea, 0x88b9782b6de95122), KEND });
#define ivd_Decoder_params "codec:?X2?Dstring?Dint,out:?DFile,errors:?X2?Dstring?Dint=!Pstrict"
	...
	args.errors = NULL;
	if (DeeArg_UnpackStructKw(argc, argv, kw, Decoder_kwlist, "oo|o:Decoder", &args))
		goto err;
/*[[[end]]]*/
...
#define decoder_close decoder_sync
PRIVATE WUNUSED NONNULL((1)) int DCALL
decoder_sync(IconvDecoder *__restrict self) {
	(void)self;
	return 0;
}
...
INTERN DeeFileTypeObject IconvDecoder_Type = {
	...
	/* .ft_seek   = */ NULL,
	/* .ft_sync   = */ (int (DCALL *)(DeeFileObject *))&decoder_sync,
	/* .ft_trunc  = */ NULL,
	/* .ft_close  = */ (int (DCALL *)(DeeFileObject *))&decoder_close,
	/* .ft_pread  = */ NULL,
	/* .ft_pwrite = */ NULL,
	/* .ft_getc   = */ NULL,
	/* .ft_ungetc = */ NULL,
