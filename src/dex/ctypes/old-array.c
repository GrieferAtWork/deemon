 ...
 */
#ifndef GUARD_DEX_CTYPES_OLD_ARRAY_C
#define GUARD_DEX_CTYPES_OLD_ARRAY_C 1
#define DEE_SOURCE
...
#include <deemon/object.h>          /* ASSERT_OBJECT_TYPE, DREF, DeeObject, DeeObject_*, DeeTypeObject, Dee_COMPARE_ISEQ, Dee_COMPARE_ISERR, Dee_Decref*, Dee_Incref, Dee_IncrefIfNotZero, Dee_XDecref, Dee_hash_t, Dee_ssize_t, ITER_DONE, OBJECT_HEAD, OBJECT_HEAD_INIT */
...
#endif /* !GUARD_DEX_CTYPES_OLD_ARRAY_C */
