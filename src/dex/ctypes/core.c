...
#include <deemon/object.h>          /* ASSERT_OBJECT, ASSERT_OBJECT_TYPE, DREF, DeeBuffer, DeeObject, DeeObject_*, DeeTypeObject, Dee_AsObject, Dee_BUFFER_FWRITABLE, Dee_Decref*, Dee_Incref, Dee_IncrefIfNotZero, Dee_TYPE, Dee_hash_t, ITER_DONE, OBJECT_HEAD_INIT, return_reference_ */
