...
INTDEF WUNUSED DREF DeeObject *DCALL capi_memrxchr(size_t argc, DeeObject *const *argv);
INTDEF WUNUSED DREF DeeObject *DCALL capi_memrxlen(size_t argc, DeeObject *const *argv);
INTDEF WUNUSED DREF DeeObject *DCALL capi_memrxend(size_t argc, DeeObject *const *argv);
...
INTDEF WUNUSED DREF DeeObject *DCALL capi_rawmemrxchr(size_t argc, DeeObject *const *argv);
INTDEF WUNUSED DREF DeeObject *DCALL capi_rawmemrxlen(size_t argc, DeeObject *const *argv);
