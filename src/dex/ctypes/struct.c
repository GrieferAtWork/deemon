...
PRIVATE struct type_method struct_type_methods[] = {
	{ "offsetof", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&struct_type_offsetof,
	  DOC("(field:?Dstring)->?Dint\n"
	      "@throw AttributeError No field with the name @field exists\n"
	      "Returns the offset of a given @field") },
	{ "offsetafter", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&struct_type_offsetafter,
	  DOC("(field:?Dstring)->?Dint\n"
	      "@throw AttributeError No field with the name @field exists\n"
	...
	{ "typeof", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&struct_type_typeof,
