...
PRIVATE DEFINE_CMETHOD(ctypes_bswap16, &f_ctypes_bswap16, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_bswap32, &f_ctypes_bswap32, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_bswap64, &f_ctypes_bswap64, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_bswap128, &f_ctypes_bswap128, METHOD_FNORMAL);
...
PRIVATE DEFINE_CMETHOD(ctypes_strlen, &capi_strlen, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strend, &capi_strend, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strnlen, &capi_strnlen, METHOD_FNORMAL);
...
PRIVATE DEFINE_CMETHOD(ctypes_stroff, &capi_stroff, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strroff, &capi_strroff, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strnoff, &capi_strnoff, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strnroff, &capi_strnroff, METHOD_FNORMAL);
...
PRIVATE DEFINE_CMETHOD(ctypes_strcmp, &capi_strcmp, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strncmp, &capi_strncmp, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strcasecmp, &capi_strcasecmp, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strncasecmp, &capi_strncasecmp, METHOD_FNORMAL);
...
PRIVATE DEFINE_CMETHOD(ctypes_strstr, &capi_strstr, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strcasestr, &capi_strcasestr, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strnstr, &capi_strnstr, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strncasestr, &capi_strncasestr, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strverscmp, &capi_strverscmp, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strspn, &capi_strspn, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(ctypes_strcspn, &capi_strcspn, METHOD_FNORMAL);
