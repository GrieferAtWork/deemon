...
INTERN struct stype_math POINTER_MATH = {
	...
	/* .st_add         = */ (DREF DeeObject *(DCALL *)(DeeSTypeObject *__restrict, void *, DeeObject *__restrict))&F(pointer_add),
	/* .st_sub         = */ (DREF DeeObject *(DCALL *)(DeeSTypeObject *__restrict, void *, DeeObject *__restrict))&F(pointer_sub),
	/* .st_mul         = */ NULL,
	/* .st_div         = */ NULL,
	/* .st_mod         = */ NULL,
	/* .st_shl         = */ NULL,
	...
	/* .st_inplace_add = */ (int (DCALL *)(DeeSTypeObject *__restrict, void *, DeeObject *__restrict))&F(pointer_inplace_add),
	/* .st_inplace_sub = */ (int (DCALL *)(DeeSTypeObject *__restrict, void *, DeeObject *__restrict))&F(pointer_inplace_sub),
	/* .st_inplace_mul = */ NULL,
	/* .st_inplace_div = */ NULL,
	/* .st_inplace_mod = */ NULL,
	/* .st_inplace_shl = */ NULL,
