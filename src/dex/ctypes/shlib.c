...
#include <deemon/type.h>            /* DeeObject_Init, DeeObject_InitInherited, DeeType_Type, Dee_XVisit, METHOD_FNOREFESCAPE, TF_NONE, TP_FNORMAL, TYPE_METHOD_END, TYPE_METHOD_F, type_* */
