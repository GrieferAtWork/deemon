...
#include <deemon/type.h>            /* DeeObject_InitStatic, DeeType_IsHeapType, DeeType_Type, Dee_TYPE_CONSTRUCTOR_INIT_FIXED, Dee_XVisit, Dee_visit_t, METHOD_FNOREFESCAPE, TF_NONE, TP_FDEEPIMMUTABLE, TP_FNORMAL, TYPE_METHOD_END, TYPE_METHOD_F, type_* */
