...
#include <deemon/object.h>          /* ASSERT_OBJECT_TYPE_EXACT, DREF, DeeObject, DeeObject_AssertTypeExact, DeeTypeObject, Dee_AsObject, Dee_Decref*, Dee_Incref, Dee_XDecref, Dee_visit_t, ITER_DONE, OBJECT_HEAD, OBJECT_HEAD_INIT */
...
#include <deemon/type.h>            /* DeeObject_Init, DeeObject_InitInherited, DeeType_Type, Dee_TYPE_CONSTRUCTOR_INIT_FIXED, Dee_XVisit, METHOD_FNOREFESCAPE, TF_NONE, TP_FNORMAL, TYPE_METHOD_END, TYPE_METHOD_F, type_* */
