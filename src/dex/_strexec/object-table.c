...
#include <deemon/object.h>          /* ASSERT_OBJECT, DREF, DeeObject, DeeObject_HasAttrStringLenHash, Dee_Decrefv, Dee_HAS_ISERR, Dee_Incref, Dee_XDecref, Dee_XIncref, Dee_hash_t, ITER_DONE, ITER_ISOK, return_reference_ */
#include <deemon/system-features.h> /* memcpy */
#include <deemon/type.h>            /* Dee_Visitv, Dee_visit_t */
