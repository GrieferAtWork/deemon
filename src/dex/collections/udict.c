...
#include <deemon/alloc.h>           /* DeeObject_*, Dee_CollectMemory, Dee_CollectMemoryc, Dee_Free, Dee_TYPE_CONSTRUCTOR_INIT_FIXED, Dee_TryCallocc, Dee_TryMallocc, _Dee_MallococBufsize */
