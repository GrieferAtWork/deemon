...
#define DeeStat_st_ino_doc       DOC("->int\n" \
...
#define DeeStat_st_rdev_doc      DOC("->int\n" \
...
#define DeeStat_st_size_doc      DOC("->int\n" \
...
#define DeeStat_isdir_doc          DOC("()->bool\n" \
                                       "@interrupt\n" \
                                       "Check if @this stat-file referrs to a directory")
#define DeeStat_ischr_doc          DOC("()->bool\n" \
                                       "@interrupt\n" \
                                       "Check if @this stat-file referrs to a character device")
#define DeeStat_isblk_doc          DOC("()->bool\n" \
                                       "@interrupt\n" \
                                       "Check if @this stat-file referrs to a block device")
#define DeeStat_isreg_doc          DOC("()->bool\n" \
                                       "@interrupt\n" \
                                       "Check if @this stat-file referrs to a regular file")
#define DeeStat_isfifo_doc         DOC("()->bool\n" \
                                       "@interrupt\n" \
                                       "Check if @this stat-file referrs to a pipe")
#define DeeStat_islnk_doc          DOC("()->bool\n" \
                                       "@interrupt\n" \
                                       "Check if @this stat-file referrs to a symbolic link")
#define DeeStat_issock_doc         DOC("()->bool\n" \
                                       "@interrupt\n" \
                                       "Check if @this stat-file referrs to a socket")
#define DeeStat_class_exists_doc   DOC("(string path)->bool\n" \
                                       "(file fp)->bool\n" \
                                       "(int fd)->bool\n" \
                                       "@interrupt\n" \
...
#define DeeStat_class_isexe_doc    DOC("(string path)->bool\n" \
                                       "(file fp)->bool\n" \
                                       "(int fd)->bool\n" \
                                       "@interrupt\n" \
                                       "Taking the same arguments as the constructor of " \
                                       ...
                                       "filename, this function always returns :false if the path-string " \
                                       "of the file described by the passed arguments cannot be determined")
#define DeeStat_TP_DOC             DOC("(string path)\n" \
                                       "(file fp)\n" \
                                       "(int fd)\n" \
                                       "@interrupt\n" \
...
#define DeeLStat_TP_DOC            DOC("(string path)\n" \
                                       "(file fp)\n" \
                                       "(int fd)\n" \
                                       "@interrupt\n" \
                                       "@throw FileNotFound The given @path or @fp could not be found\n" \
...
#define DeeDir_TP_DOC              DOC("(string path)\n" \
                                       "(file fp)\n" \
                                       "(int fd)\n" \
                                       "@interrupt\n" \
...
#define DeeQueryIterator_TP_DOC    DOC("Construct a directory iteration descriptor that yields the names " \
                                       "of all filesystem objects found within a the associated directory")
#define DeeQuery_TP_DOC            DOC("(string pattern)\n" \
                                       "@interrupt\n" \
