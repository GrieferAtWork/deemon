...
#define DeeUser_static_name_doc                                                \
	DOC("->?Dstring\n"                                                         \
...
#define DeeStat_class_isdir_doc                                   \
	DOC("(path:?Dstring)->?Dbool\n"                               \
	    "(fp:?DFile)->?Dbool\n"                                   \
	    "(fd:?Dint)->?Dbool\n"                                    \
	    "@interrupt\n"                                            \
...
#define DeeStat_class_ischr_doc                                   \
	DOC("(path:?Dstring)->?Dbool\n"                               \
	    "(fp:?DFile)->?Dbool\n"                                   \
	    "(fd:?Dint)->?Dbool\n"                                    \
	    "@interrupt\n"                                            \
...
#define DeeStat_class_isblk_doc                                   \
	DOC("(path:?Dstring)->?Dbool\n"                               \
	    "(fp:?DFile)->?Dbool\n"                                   \
	    "(fd:?Dint)->?Dbool\n"                                    \
	    "@interrupt\n"                                            \
...
#define DeeStat_class_isreg_doc                                   \
	DOC("(path:?Dstring)->?Dbool\n"                               \
	    "(fp:?DFile)->?Dbool\n"                                   \
	    "(fd:?Dint)->?Dbool\n"                                    \
	    "@interrupt\n"                                            \
...
#define DeeStat_class_isfifo_doc                                  \
	DOC("(path:?Dstring)->?Dbool\n"                               \
	    "(fp:?DFile)->?Dbool\n"                                   \
	    "(fd:?Dint)->?Dbool\n"                                    \
	    "@interrupt\n"                                            \
...
#define DeeStat_class_islnk_doc                                   \
	DOC("(path:?Dstring)->?Dbool\n"                               \
	    "(fp:?DFile)->?Dbool\n"                                   \
	    "(fd:?Dint)->?Dbool\n"                                    \
	    "@interrupt\n"                                            \
...
#define DeeStat_class_issock_doc                                  \
	DOC("(path:?Dstring)->?Dbool\n"                               \
	    "(fp:?DFile)->?Dbool\n"                                   \
	    "(fd:?Dint)->?Dbool\n"                                    \
	    "@interrupt\n"                                            \
...
#define DeeStat_class_ishidden_doc                                          \
	DOC("(path:?Dstring)->?Dbool\n"                                         \
	    "(fp:?DFile)->?Dbool\n"                                             \
	    "(fd:?Dint)->?Dbool\n"                                              \
	    "@interrupt\n"                                                      \
...
#define DeeStat_class_isexe_doc                                               \
	DOC("(path:?Dstring)->?Dbool\n"                                           \
	    "(fp:?DFile)->?Dbool\n"                                               \
	    "(fd:?Dint)->?Dbool\n"                                                \
	    "@interrupt\n"                                                        \
...
#define DeeDir_TP_DOC       \
	DOC("(path:?Dstring)\n" \
	    "(fp:?DFile)\n"     \
	    "(fd:?Dint)\n"      \
	    "@interrupt\n"      \
	    "Construct a sequence for enumerating the contents of a directory")
#define DeeQueryIterator_TP_DOC                                             \
	DOC("Construct a directory iteration descriptor that yields the names " \
	    "of all filesystem objects found within a the associated directory")
#define DeeQuery_TP_DOC                                                        \
	DOC("(pattern:?Dstring)\n"                                                 \
	    "@interrupt\n"                                                         \
