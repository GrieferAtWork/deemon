...
DEFINE_LIBFS_FORWARD_WRAPPER_S(copyfile)
...
/*[[[deemon import("rt.gen.dexutils").gw("fchownat", "dfd:d,filename:c:char[],owner:?X3?Efs:User?Dstring?Dint,group:?X3?Efs:Group?Dstring?Dint,atflags:d->?Dint", libname: "posix"); ]]]*/
