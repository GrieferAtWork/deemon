...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_atexit_f(size_t argc, DeeObject **argv, DeeObject *kw);
...
#define POSIX_KWDS_CALLBACK_ARGS_DEFINED 1
...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_exit_f(size_t argc, DeeObject **argv, DeeObject *kw);
...
#define POSIX_KWDS_EXITCODE_DEFINED 1
...
PRIVATE WUNUSED DREF DeeObject *DCALL posix__Exit_f(size_t argc, DeeObject **argv, DeeObject *kw);
...
PRIVATE WUNUSED DREF DeeObject *DCALL posix_abort_f(size_t argc, DeeObject **argv);
