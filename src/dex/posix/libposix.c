...
#include <deemon/system-features.h> /* CONFIG_HAVE_errno, CONFIG_HAVE_memmem, DTTOIF, DT_BLK, DT_CHR, DT_DIR, DT_FIFO, DT_LNK, DT_REG, DT_SOCK, DT_UNKNOWN, DT_WHT, DeeSystem_DEFINE_memmem, IFTODT, O_CREAT, O_TRUNC, O_WRONLY, access, environ, errno, fdopendir, link, lstat, memmem, open, opendir, read, readlink, realpath, remove, rename, setenv, stat, symlink, system, time, unlink, unsetenv, write */
...
D(POSIX_RMDIR_DEF_DOC("#t{:Interrupt}"
                      ...
                      "#tDirectoryNotEmpty{The given directory @path isn't empty empty}"
...
D(POSIX_RMDIRAT_DEF_DOC("#t{:Interrupt}"
                        ...
                        /*              */ "delete it, or it is a mounting point if such functionality is supported by the host}"
                        "#tDirectoryNotEmpty{The given directory @dfd:@path isn't empty empty}"
...
D(POSIX_REMOVE_DEF_DOC("#t{:Interrupt}"
                       "#tFileNotFound{The given @path does not exist}"
                       "#tNoDirectory{A part of the given @path is not a directory}"
                       "#tDirectoryNotEmpty{The given @path is a directory that isn't empty empty}"
                       "#tBusyFile{The given @path is currently being used and cannot be deleted}"
...
D(POSIX_REMOVEAT_DEF_DOC("#t{:Interrupt}"
                         "#tFileNotFound{The given @dfd:@path does not exist}"
                         "#tNoDirectory{A part of the given @dfd:@path is not a directory}"
                         "#tDirectoryNotEmpty{The given @dfd:@path is a directory that isn't empty empty}"
                         "#tBusyFile{The given @dfd:@path is currently being used and cannot be deleted}"
...
D(POSIX_RENAME_DEF_DOC("#t{:Interrupt}"
                       ...
                       "#tDirectoryNotEmpty{The given @newpath is a non-empty directory}"
                       ...
                       "#tCrossDeviceLink{The given @oldpath and @newpath are not located on the same device}"
...
D(POSIX_FRENAME_DEF_DOC("#t{:Interrupt}"
                        ...
                        "#tCrossDeviceLink{The given @oldfd and @newpath are not located on the same device}"
                        "#tValueError{Attempted to move a directory into itself}"
                        "#tFileAccessError{The current user does not have permissions to access the file "
...
D(POSIX_RENAMEAT_DEF_DOC("#t{:Interrupt}"
                         ...
                         "#tDirectoryNotEmpty{The given @newdirfd:@newpath is a non-empty directory}"
                         ...
                         "#tCrossDeviceLink{The given @olddirfd:@oldpath and @newdirfd:@newpath are not located on the same device}"
                         "#tValueError{Attempted to move a directory into itself}"
                         "#tFileAccessError{The current user does not have permissions to access the file "
...
D(POSIX_LINK_DEF_DOC("#t{:Interrupt}"
                     ...
                     "#tCrossDeviceLink{The given @oldpath and @newpath are not apart of the same drive}"
...
D(POSIX_FLINK_DEF_DOC("#t{:Interrupt}"
                      ...
                      "#tCrossDeviceLink{The given @oldfd and @newpath are not apart of the same drive}"
                      "#tFileAccessError{The current user does not have permissions to access the file or directory "
...
D(POSIX_LINKAT_DEF_DOC("#t{:Interrupt}"
                       ...
                       "#tCrossDeviceLink{The given @olddirfd:@oldpath and @newdirfd:@newpath are not apart of the same drive}"
                       "#tFileAccessError{The current user does not have permissions to access the file or directory "
