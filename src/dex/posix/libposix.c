...
PRIVATE DEFINE_CMETHOD(libposix_S_ISDIR, &posix_S_ISDIR, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(libposix_S_ISCHR, &posix_S_ISCHR, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(libposix_S_ISBLK, &posix_S_ISBLK, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(libposix_S_ISDEV, &posix_S_ISDEV, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(libposix_S_ISREG, &posix_S_ISREG, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(libposix_S_ISFIFO, &posix_S_ISFIFO, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(libposix_S_ISLNK, &posix_S_ISLNK, METHOD_FNORMAL);
PRIVATE DEFINE_CMETHOD(libposix_S_ISSOCK, &posix_S_ISSOCK, METHOD_FNORMAL);
