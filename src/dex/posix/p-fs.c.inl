...
/*[[[deemon import("rt.dexutils").gw("unlink", "file:?Dstring", libname: "posix");]]]*/
...
/*[[[deemon import("rt.dexutils").gw("rmdir", "path:?Dstring", libname: "posix");]]]*/
...
/*[[[deemon import("rt.dexutils").gw("remove", "path:?Dstring", libname: "posix");]]]*/
...
/*[[[deemon import("rt.dexutils").gw("unlinkat", "dfd:?X3?DFile?Dint?Dstring,file:?Dstring,atflags:u=0", libname: "posix");]]]*/
...
/*[[[deemon import("rt.dexutils").gw("removeat", "dfd:?X3?DFile?Dint?Dstring,path:?Dstring,atflags:u=0", libname: "posix");]]]*/
...
/*[[[deemon import("rt.dexutils").gw("rmdirat", "dfd:?X3?DFile?Dint?Dstring,path:?Dstring,atflags:u=0", libname: "posix");]]]*/
