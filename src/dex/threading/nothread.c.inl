...
PRIVATE struct type_method sema_methods[] = {
	{ "post", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **))&sema_post,
	  DOC("(count=!1)\n"
	      "Post @count tickets to the semaphore") },
	{ "wait", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **))&sema_wait,
	  DOC("()\nWait for the semaphore to become ready and acquire a ticket") },
	{ "trywait", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **))&sema_trywait,
	  DOC("->?Dbool\n"
	      "@interrupt\n"
	...
	{ "timedwait", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **))&sema_timedwait,
