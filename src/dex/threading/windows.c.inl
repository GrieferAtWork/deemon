...
PRIVATE struct type_method sema_methods[] = {
	{ "post",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&sema_post,
	  DOC("(count=!1)\n"
	      "Post @count tickets to the semaphore") },
	{ "wait",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&sema_wait,
	  DOC("()\n"
	      "Wait for the semaphore to become ready and acquire a ticket") },
	{ "trywait",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&sema_trywait,
	  DOC("->?Dbool\n"
	      "@interrupt\n"
	...
	{ "timedwait",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&sema_timedwait,
	...
	{ "fileno",
	  (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&sema_fileno,
	  DOC("->?Dint\n"
...
PRIVATE struct type_method mutex_methods[] = {
	{ "acquire", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&mutex_acquire,
	  DOC("()\n"
	      "Wait for the mutex to becomes available and recursive acquires an exclusive lock") },
	{ "tryacquire", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&mutex_tryacquire,
	  DOC("->?Dbool\n"
	      "Try to recursive acquire an exclusive lock but fail and "
	      "return :false if this is not possible without blocking") },
	{ "timedacquire", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&mutex_timedacquire,
	  DOC("(timeout_microseconds:?Dint)->?Dbool\n"
	      "Try to recursive acquire an exclusive lock but fail and "
	      "return :false if the given @timeout_microseconds has passed") },
	{ "release", (DREF DeeObject *(DCALL *)(DeeObject *, size_t, DeeObject **__restrict))&mutex_release,
	  DOC("()\n"
