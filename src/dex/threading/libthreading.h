...
INTDEF void DCALL thread_tls_fini(struct tls_descriptor *__restrict data);
INTDEF void DCALL thread_tls_visit(struct tls_descriptor *__restrict data, dvisit_t proc, void *arg);
