...
INTERN DeeTypeObject DeeLockUnion_Type = {
	...
	/* .tp_doc      = */ DOC("A special type of lock that represents the union of multiple locks. "
	                         ...
	                         /**/ "during this process some lock cannot be acquired immediately, all other "
	                         /**/ "locks that have already been acquired are released once more, and the lock "
	                         /**/ "that could not be acquired without blocking is now acquired #Bwith bocking. "
	                         ...
	                         /**/ "being treated like the first lock was in the first iteration. This is then "
	                         /**/ "repeated until all locks could be acquired at the same time.\n"
