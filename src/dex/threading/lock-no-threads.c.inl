...
#include <deemon/util/lock.h>  /* Dee_ATOMIC_LOCK_INIT, Dee_ATOMIC_LOCK_INIT_ACQUIRED, Dee_ATOMIC_RWLOCK_*, Dee_SEMAPHORE_INIT, Dee_SHARED_LOCK_INIT, Dee_SHARED_LOCK_INIT_ACQUIRED, Dee_SHARED_RWLOCK_*, Dee_atomic_lock_*, Dee_atomic_rwlock_*, Dee_semaphore_*, Dee_shared_lock_*, Dee_shared_rwlock_*, _Dee_atomic_lock_release_NDEBUG, _Dee_atomic_rwlock_*, _Dee_shared_rwlock_upgrade_NDEBUG, _Dee_shared_rwlock_upgrade_noint_NDEBUG */
