...
#include <deemon/object.h>          /* DREF, DeeObject, DeeObject_Call, DeeObject_Type, DeeTypeObject, Dee_AsObject, Dee_BOUND_FROMBOOL, Dee_Decref, Dee_Incref, Dee_Incref_n, Dee_XDecref, Dee_XIncref, Dee_formatprinter_t, Dee_ssize_t, ITER_DONE, ITER_ISOK, OBJECT_HEAD, OBJECT_HEAD_INIT */
