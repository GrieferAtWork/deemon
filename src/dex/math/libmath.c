...
PRIVATE struct dex_symbol symbols[] = {
    { "acos", (DeeObject *)&math_acos, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the arc cosine of @x") },
    { "acosh", (DeeObject *)&math_acosh, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the area hyperbolic cosine of @x") },
    { "asin", (DeeObject *)&math_asin, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the arc sinus of @x") },
    { "asinh", (DeeObject *)&math_asinh, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the area hyperbolic sine of @x") },
    { "atan", (DeeObject *)&math_atan, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the arc tangent of @x") },
    { "atan2", (DeeObject *)&math_atan2, MODSYM_FNORMAL, DOC("(float x,float y)->float\nReturns the arc tangent of @x and @y") },
    { "atanh", (DeeObject *)&math_atanh, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the area hyperbolic tangent of @x") },
    { "cbrt", (DeeObject *)&math_cbrt, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the cubic root of @x") },
    { "ceil", (DeeObject *)&math_ceil, MODSYM_FNORMAL, DOC("(float x)->float\nReturns @x rounded to the next greater decimal") },
    { "copysign", (DeeObject *)&math_copysign, MODSYM_FNORMAL, DOC("(float x,float y)->float\nReturn @x with the sign copied from @y") },
    { "cos", (DeeObject *)&math_cos, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the cosine of @x") },
    { "cosh", (DeeObject *)&math_cosh, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the hyperbolic cosine of @x") },
    { "erf", (DeeObject *)&math_erf, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the error of @x") },
    { "erfc", (DeeObject *)&math_erfc, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the complementary error of @x") },
    { "exp", (DeeObject *)&math_exp, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the exponential of @x") },
    { "exp2", (DeeObject *)&math_exp2, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the binary exponential of @x") },
    { "expm1", (DeeObject *)&math_expm1, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the exponential of @x minus ${1.0}") },
    { "fabs", (DeeObject *)&math_fabs, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the absolute value of @x") },
    { "floor", (DeeObject *)&math_floor, MODSYM_FNORMAL, DOC("(float x)->float\nReturns @x rounded to the next smaller decimal") },
    { "fmod", (DeeObject *)&math_fmod, MODSYM_FNORMAL, DOC("(float x,float x)->float\nReturns the floating point remainder of @x divided by @y") },
    { "frexp", (DeeObject *)&math_frexp, MODSYM_FNORMAL, DOC("(float x)->(float,int)\nReturns the mantissa and exponent of @x") },
    { "ilogb", (DeeObject *)&math_ilogb, MODSYM_FNORMAL, DOC("(float x)->int\nreturn binary logarithm of @x") },
    { "inf", (DeeObject *)&math_inf, MODSYM_FNORMAL, DOC("A special floating point value, representing INFinity") },
    { "isfinite", (DeeObject *)&math_isfinite, MODSYM_FNORMAL, DOC("(float x)->bool\nReturns :true if @x is infinite") },
    { "isinf", (DeeObject *)&math_isinf, MODSYM_FNORMAL, DOC("(float x)->bool\nReturns :true if @x is infinite") },
    { "isnan", (DeeObject *)&math_isnan, MODSYM_FNORMAL, DOC("(float x)->bool\nReturns :true if @x is NotANumber") },
    { "isnormal", (DeeObject *)&math_isnormal, MODSYM_FNORMAL, DOC("(float x)->bool\nReturns :true if @x is a normal number") },
    { "ldexp", (DeeObject *)&math_ldexp, MODSYM_FNORMAL, DOC("(float significand,int exponent)->float\nGenerate value from significand and exponent of @x") },
    { "log", (DeeObject *)&math_log, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the natural logarithm of @x") },
    { "log10", (DeeObject *)&math_log10, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the common logarithm of @x") },
    { "log1p", (DeeObject *)&math_log1p, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the logarithm of @x logarithm plus ${1.0}") },
    { "log2", (DeeObject *)&math_log2, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the binary logarithm of @x") },
    { "logb", (DeeObject *)&math_logb, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the floating-point base logarithm of @x") },
    { "modf", (DeeObject *)&math_modf, MODSYM_FNORMAL, DOC("(float x)->(float,float)\nReturns the fractional and integral parts of @x") },
    { "nan", (DeeObject *)&math_nan, MODSYM_FNORMAL, DOC("A special floating point value, representing NotANumber") },
    { "tau", (DeeObject *)&math_tau, MODSYM_FNORMAL, DOC("The mathematical constant TAU ${pi * 2}") },
    { "pi", (DeeObject *)&math_pi, MODSYM_FNORMAL, DOC("The mathematical constant PI") },
    { "e", (DeeObject *)&math_e, MODSYM_FNORMAL, DOC("The mathematical constant E") },
    { "pow", (DeeObject *)&math_pow, MODSYM_FNORMAL, DOC("(float x,float y)->float\nReturns @x to the power of @y") },
    { "round", (DeeObject *)&math_round, MODSYM_FNORMAL, DOC("(float x)->float\nReturns @x rounded to the next nearest decimal") },
    { "sin", (DeeObject *)&math_sin, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the sinus of @x") },
    { "sinh", (DeeObject *)&math_sinh, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the hyperbolic sinus of @x") },
    { "sqrt", (DeeObject *)&math_sqrt, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the square root of @x") },
    { "tan", (DeeObject *)&math_tan, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the tangent of @x") },
    { "tanh", (DeeObject *)&math_tanh, MODSYM_FNORMAL, DOC("(float x)->float\nReturns the hyperbolic tangent of @x") },
    { NULL }
};
