...
#ifndef NDEBUG
#define NDEBUG
#define _Dee_PRIVATE_NDEBUG_FOR_EXTERNAL_SQLITE3_H
#endif /* !NDEBUG */
#include "../../external/sqlite-amalgamation-3500400/sqlite3.h"
#ifdef _Dee_PRIVATE_NDEBUG_FOR_EXTERNAL_SQLITE3_H
#undef _Dee_PRIVATE_NDEBUG_FOR_EXTERNAL_SQLITE3_H
#undef NDEBUG
#endif /* _Dee_PRIVATE_NDEBUG_FOR_EXTERNAL_SQLITE3_H */
