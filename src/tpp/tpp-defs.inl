...
/* 9*/DEF_WARNING(W_EXPECTED_MACRO_ARGUMENT_NAME,(WG_SYNTAX),WSTATE_ERROR,WARNF("Expected argument name, but got " TOK_S,TOK_A))                                  /* [tok_t] OLD(TPPWarn_ExpectedKeywordForMacroArgument). */
/*10*/DEF_WARNING(W_EXPECTED_ARGEND_AFTER_VARARGS,(WG_SYNTAX),WSTATE_ERROR,WARNF("Expected end of argument list after arg-args, but got " TOK_S,TOK_A))           /* [tok_t] OLD(TPPWarn_ExpectedRParenAfterVaArgs). */
/*11*/DEF_WARNING(W_EXPECTED_COMMA_OR_ARGEND,(WG_SYNTAX),WSTATE_ERROR,WARNF("Expected " Q(",") " or end of argument list, but got " TOK_S,TOK_A))                 /* [tok_t] OLD(TPPWarn_ExpectedCommaOrRParenForMacroFuncDecl). */
