...
CFLAGS_src = $(CFLAGS) -I$(call relpath,$(SRC_ROOT)/include,$(PWD)) -Wall -Wextra -Wno-address -Wno-comment -Wno-array-bounds
...
## =======================================================================
define LINK_RECIPE
#LR_canon_names_asc=lib_rt.dll lib
#LR_canon_names_dsc=lib lib_rt.dll
...
# NOTE: Argument materialization must only happen *within* the rule such that '$(shell)'
#       replacements happen for every binary, and only happen once that binary is supposed
#       to be built!
